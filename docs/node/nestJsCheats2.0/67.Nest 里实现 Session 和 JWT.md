...
![](images/image-1966.jpg)

然后用 postman 测试下：

![](images/image-1967.jpg)
...
![](images/image-1971.jpg)

放到请求的 header 里：

![](images/image-1972.jpg)

这时候响应为 2，并且返回一个新的 token：

![](images/image-1973.jpg)

把它复制下来放到 header 里再次请求：

![](images/image-1974.jpg)
