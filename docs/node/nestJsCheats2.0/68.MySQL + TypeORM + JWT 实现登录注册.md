...
![](images/image-1977.jpg)

刷新后就可以看到这个数据库了：

![](images/image-1978.jpg)

然后我们创建个 nest 项目：

    nest new login-and-register -p npm

![](images/image-1979.jpg)
...
![](images/image-1980.jpg)

引入 User 的 entity：

![](images/image-1981.jpg)
...
![](images/image-1988.jpg)

我们先在 postman 里测试下：

![](images/image-1989.jpg)

post 请求 /user/login 接口，body 传入用户信息。

服务端打印了收到的 user：

![](images/image-1990.jpg)

然后 post 请求 /user/register：

![](images/image-1991.jpg)
...
![](images/image-1992.jpg)

我们测试下：

![](images/image-1993.jpg)

服务返回了注册成功，并且打印了 insert 的 sql：

![](images/image-1994.jpg)

可以看到，数据库 user 表插入了这个用户的信息，并且指定了 createTime 和 udpateTime。

![](images/image-1995.jpg)

然后我们再次调用：

![](images/image-1996.jpg)
...
![](images/image-1997.jpg)

用户名不存在：
![](images/image-1998.jpg)

用户名存在但密码错误：

![](images/image-1999.jpg)

可以看到，服务端打印了 3 条 select 的 sql：

![](images/image-2000.jpg)
...
![](images/image-2003.jpg)

再次访问：

![](images/image-2004.jpg)

![](images/image-2005.jpg)
...
![](images/image-2006.jpg)

![](images/image-2007.jpg)
...
![](images/image-2008.jpg)

我们先登录一下，拿到 token：

![](images/image-2009.jpg)

然后请求 /aaa 的时候通过 authorization 的 header 带上 token：

![](images/image-2010.jpg)
...
![](images/image-2014.jpg)

![](images/image-2015.jpg)

![](images/image-2016.jpg)

ValidationPipe 生效了。

这样，我们就实现了登录、注册和鉴权的完整功能。

![](images/image-2017.jpg)

![](images/image-2018.jpg)

![](images/image-2019.jpg)
