...
![](images/image-2509.jpg)

这两天国庆节，大家出去玩可能会借用共享充电宝。它也是基于你的位置来搜索附近充电宝：

![](images/image-2510.jpg)
...
![](images/image-2518.jpg)

比如上面我们分别在地图上绘制了 marker 和 circle：

这是添加 Marker 的代码：

![](images/image-2519.jpg)

指定 marker 的经纬度和图片就行。

这是添加 Circle 的代码：

![](images/image-2520.jpg)
...
![](images/image-2531.jpg)

没啥问题。

在 AppController 添加两个路由：

![](images/image-2532.jpg)
...
![](images/image-2533.jpg)

![](images/image-2534.jpg)

最后，还要提供一个搜索附近的点的接口：

在 RedisService 添加 geoSearch 方法，传入 key，经纬度、搜索半径，返回附近的点：

![](images/image-2535.jpg)
...
![](images/image-2539.jpg)

不过现在的经纬度我们是随便给的。

可以用高德地图的坐标拾取工具来取几个位置：

![](images/image-2540.jpg)

天安门： 116.397444,39.909183

![](images/image-2541.jpg)

文化宫科技馆：116.3993,39.908578

![](images/image-2542.jpg)

售票处：116.397283,39.90943

![](images/image-2543.jpg)

故宫彩扩部：116.398002,39.909175

![](images/image-2544.jpg)
...
![](images/image-2554.jpg)

接下来引入 axios，来调用服务端接口：

![](images/image-2555.jpg)
...
![](images/image-2556.jpg)

然后把 radius 改成 0.05，是这样的：

![](images/image-2557.jpg)
