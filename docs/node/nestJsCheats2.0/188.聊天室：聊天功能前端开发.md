...
![](images/image-5854.jpg)

![](images/image-5855.jpg)
...
![](images/image-5856.jpg)

然后我们加上聊天的功能：

![](images/image-5857.jpg)

用绝对定位把这个 div 定位在右下角：

![](images/image-5858.jpg)

![](images/image-5859.jpg)
![](images/image-5860.jpg)
...
![](images/image-5861.jpg)

我们改下 .message-list 的高度

![](images/image-5862.jpg)
...
![](images/image-5863.jpg)

```css
border-bottom: 0;
```

![](images/image-5864.jpg)

这样，布局就完成了。

我们来加一下发消息的功能：

![](images/image-5865.jpg)

用 inputText 的 state 保存输入的内容，点击发送的时候调用 sendMessage 方法。

![](images/image-5866.jpg)

sendMessage 方法从 localStorage 拿 userId，然后单独一个 state 保存 chatroomId。

![](images/image-5867.jpg)

点击切换聊天室的时候 setChatroomId

![](images/image-5868.jpg)

当收到新的消息的时候重新查询聊天记录

![](images/image-5869.jpg)

roomId 改变的时候重新链接一下：

![](images/image-5870.jpg)
...
![](images/image-5871.jpg)

聊天没问题，就是样式不大对。

我们加一下判断：

![](images/image-5872.jpg)

![](images/image-5873.jpg)

```javascript
className={`message-item ${item.senderId === userInfo.id ? 'from-me' : ''}`}
```

![](images/image-5874.jpg)

现在样式就对了，只不过自己聊没意思。

在数据库里查一下上面那个聊天室的另一个用户：

![](images/image-5875.jpg)

![](images/image-5876.jpg)

换个浏览器登录小强的账号：

![](images/image-5877.jpg)

然后在光的账号这边看下：

![](images/image-5878.jpg)

收到了小强的消息。

我们聊一会天：

![](images/image-5879.jpg)
...
![](images/image-5880.jpg)

![](images/image-5881.jpg)
...
![](images/image-5883.jpg)

此外，sender 的信息也要查出来：

把 UserService 导出，然后在 chat 模块引入：

![](images/image-5884.jpg)

![](images/image-5885.jpg)

返回 history 的时候把 sender 也查出来：

![](images/image-5886.jpg)
...
![](images/image-5887.jpg)

![](images/image-5888.jpg)
