...
![](images/image-5512.jpg)

生成的代码很容易看懂：

![](images/image-5513.jpg)
...
![](images/image-5515.jpg)

浏览器访问下 http://localhost:3000

![](images/image-5516.jpg)
...
![](images/image-5517.jpg)

分别指定 event 和 data。

这时候原来的代码就收不到 findAll 返回的消息了：

![](images/image-5518.jpg)

因为返回的消息是 guang，可以加一下这个事件的监听：

![](images/image-5519.jpg)
...
![](images/image-5526.jpg)

同样，也是不建议用的。

此外，服务端也有 connected、disconnected 等生命周期函数：

![](images/image-5527.jpg)
