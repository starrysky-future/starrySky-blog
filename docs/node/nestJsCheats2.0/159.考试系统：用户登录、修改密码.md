...
![](images/image-5182.jpg)

![](images/image-5183.jpg)

服务端打印了接收的参数。

ValidationPipe 开启 transform: true

![](images/image-5184.jpg)

再次访问：

![](images/image-5185.jpg)
...
![](images/image-5186.jpg)

当密码错误时：
![](images/image-5187.jpg)

登录成功：

![](images/image-5188.jpg)
...
![image.png](images/image.png-5189.jpg)
...
![image.png](images/image.png-5193.jpg)

然后全局启用这个 Guard，在 UserModule 里添加这个 provider：

![image.png](images/image.png-5194.jpg)
...
![image.png](images/image.png-5195.jpg)

![image.png](images/image.png-5196.jpg)
...
![image.png](images/image.png-5197.jpg)

而 bbb 还是可以直接访问的：

![image.png](images/image.png-5198.jpg)

登录下，拿到 token：

![image.png](images/image.png-5199.jpg)

添加到 authorization 的 header 里，就可以访问了：

![image.png](images/image.png-5200.jpg)
...
![image.png](images/image.png-5201.jpg)
然后就可以通过在 controller 或者 handler 上的 @RequiredLogin 来声明接口需要登录了：

![image.png](images/image.png-5202.jpg)
...
![image.png](images/image.png-5205.jpg)
...
![image.png](images/image.png-5206.jpg)

![image.png](images/image.png-5207.jpg)
然后实现下具体的更新密码的逻辑：
...
![image.png](images/image.png-5208.jpg)

在 redis 里手动添加 update*password_captcha*邮箱 的 key，值为 111111

![image.png](images/image.png-5209.jpg)

半小时过期。

![image.png](images/image.png-5210.jpg)

然后再试下：

![image.png](images/image.png-5211.jpg)

修改成功。

我们为了开发方便没对密码做加密，可以直观看出来密码修改成功了：

![image.png](images/image.png-5212.jpg)
...
![image.png](images/image.png-5213.jpg)

![image.png](images/image.png-5214.jpg)

用这个验证码修改下密码：

![image.png](images/image.png-5215.jpg)

![image.png](images/image.png-5216.jpg)
