...
![](images/image-1446.jpg)

```sql
select * from employee;
```

![](images/image-1447.jpg)

改一下员工的部门，点击 apply：

![](images/image-1448.jpg)
...
![](images/image-1458.jpg)

可以看到技术部的员工的名字都改了：

![](images/image-1459.jpg)
