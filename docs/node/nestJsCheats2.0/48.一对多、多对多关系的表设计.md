...
![](images/image-1398.jpg)

一个订单有多个商品，而商品只属于一个订单。

![](images/image-1399.jpg)

一个部门有多个员工，员工只属于一个部门。

![](images/image-1400.jpg)

多对多的关系也是随处可见：

一篇文章可以有多个标签，一个标签可以多篇文章都有。

![](images/image-1401.jpg)

一个学生可以选修多门课程，一门课程可以被多个学生选修。

![](images/image-1402.jpg)

一个用户可以有多个角色，一个角色可能多个用户都有。

![](images/image-1403.jpg)
...
![](images/image-1404.jpg)

在员工表添加外键 department_id 来表明这种多对一关系：

![](images/image-1405.jpg)

其实和一对一关系的数据表设计是一样的。

我们添加这两个表。

![](images/image-1406.jpg)
...
![](images/image-1407.jpg)

同样的方式创建 employee 表：

![](images/image-1408.jpg)
...
![](images/image-1409.jpg)

点击 apply 就创建成功了。

![](images/image-1410.jpg)
...
![](images/image-1411.jpg)

查询下：

![](images/image-1412.jpg)
...
![](images/image-1413.jpg)

查询下：

![](images/image-1414.jpg)
...
![](images/image-1417.jpg)

然后把 id 为 5 的部门删掉：

![](images/image-1418.jpg)

点击 apply。

再查看下员工表，可以看到销售部下的 3 个员工的部门被设置为 null 了：

![](images/image-1419.jpg)
...
![](images/image-1423.jpg)

查询下：

![](images/image-1424.jpg)
...
![](images/image-1425.jpg)

再查询下：

![](images/image-1426.jpg)
...
![](images/image-1428.jpg)

然后查询下：

![](images/image-1429.jpg)
...
![](images/image-1431.jpg)

![](images/image-1432.jpg)
...
![](images/image-1434.jpg)

输入 sql 后点击执行。

然后就可以看到插入的数据了：

![](images/image-1435.jpg)
...
![](images/image-1438.jpg)

然后再执行下面的查询：

![](images/image-1439.jpg)

可以看到关系也被级联删除了，这就是 CASCADE 的作用。

当然，删除的只是关系，并不影响 id=1 的标签：

![](images/image-1440.jpg)
