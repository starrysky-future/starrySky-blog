...
![](images/image-1274.jpg)

这就是这个表的数据：

![](images/image-1275.jpg)

点击第一个图标，会展示表的信息，比如多少列、多少行、占据了多大的空间等：

![](images/image-1276.jpg)

点击第二个图标是修改表的列的定义的：

![](images/image-1277.jpg)
...
![](images/image-1279.jpg)

输入名字，指定字符集，点击右下角的 apply。

创建成功之后，就可以看到我们刚建的数据库了：

![](images/image-1280.jpg)

选中 hello-mysql 数据库，点击创建 table 的按钮，我们来建个表：

![](images/image-1281.jpg)

输入表名 student。

先建立 id 列：

![](images/image-1282.jpg)
...
![](images/image-1290.jpg)

下面是执行结果，可以看到都插入成功了，一共 3 行。

![](images/image-1291.jpg)

然后再选中上面的查询 sql 来执行：

![](images/image-1292.jpg)

下面也同样会展示查询 sql 的执行情况，一共返回了 4 行数据：

![](images/image-1293.jpg)

新增学会了，修改和删除呢？

我们同样可视化操作一下，然后看看 sql：

![](images/image-1294.jpg)

![](images/image-1295.jpg)
...
![](images/image-1296.jpg)

点击 review sql
![](images/image-1297.jpg)

![](images/image-1298.jpg)

删除是 drop：

![](images/image-1299.jpg)
...
![](images/image-1303.jpg)

本地对应的目录也修改了：

![](images/image-1304.jpg)
