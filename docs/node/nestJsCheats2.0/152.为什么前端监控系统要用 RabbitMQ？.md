...
![](images/image-4985.jpg)

这个版本是有 web 管理界面的。

点击 run：

![](images/image-4986.jpg)
...
![](images/image-4987.jpg)

就可以在浏览器访问 http://localhost:15672 了：

![](images/image-4988.jpg)

这就是它的 web 管理界面。

输入 guest、guest 进入管理页面：

![](images/image-4989.jpg)
...
![](images/image-4991.jpg)

![](images/image-4992.jpg)

之后就可以在管理界面看到这个队列了：

![](images/image-4993.jpg)
...
![](images/image-4999.jpg)

这就是通过 direct 交换机发送消息的过程。

在管理页面上也可以看到这个交换机的信息：

![](images/image-5000.jpg)
...
![](images/image-5001.jpg)

可以看到，两个消费者分别收到了不同 routing key 对应的消息。

当然，在管理界面这里也是可以发消息的：

![](images/image-5002.jpg)

消费者端同样可以收到：

![](images/image-5003.jpg)
