...
![](images/image-3759.jpg)

![](images/image-3760.jpg)
...
![](images/image-3771.jpg)

测试下：

请求 /user/update_password/captcha 接口发送验证码：

![](images/image-3772.jpg)

![](images/image-3773.jpg)

然后请求 /user/update_password 接口：

![](images/image-3774.jpg)

提示修改密码成功。

我们在页面登录下试试：

![](images/image-3775.jpg)
...
![](images/image-3778.jpg)

填入邮箱，点击发送验证码。

提示发送成功。

![](images/image-3779.jpg)

邮箱里也收到了这个验证码。

然后填入新密码，点击修改密码按钮：

![](images/image-3780.jpg)

提示修改成功，然后会跳到登录页面：

![](images/image-3781.jpg)
...
![](images/image-3785.jpg)

![](images/image-3786.jpg)

![](images/image-3787.jpg)

没啥问题。

然后在下面添加 update_info 路由，并实现 page/update_info/UpdateInfo 组件：

![](images/image-3788.jpg)
...
![](images/image-3790.jpg)

/user/update 接口需要在 body 传这么几个参数：

![](images/image-3791.jpg)

/user/update/captcha 需要传一个邮箱地址：

![](images/image-3792.jpg)
...
![](images/image-3801.jpg)

然后用这个 accessToken 访问下发送验证码接口：

![](images/image-3802.jpg)

发送成功，收到了这个验证码：

![](images/image-3803.jpg)

然后调用下查询用户信息的接口：

![](images/image-3804.jpg)

之后调用修改接口：

![](images/image-3805.jpg)

在数据库里看下，用户信息已经改过来了：

![](images/image-3806.jpg)
...
![](images/image-3807.jpg)

请求没有发送成功时，错误对象没有 response 属性。

接下来，我们先登录下：

![](images/image-3808.jpg)

给用户图标添加跳到 /update_info 的链接：

![](images/image-3809.jpg)

![](images/image-3810.jpg)

然后可以看到控制台打印了当前登录用户的信息：

![](images/image-3811.jpg)

然后我们做下回显：

![](images/image-3812.jpg)
...
![](images/image-3814.jpg)

![](images/image-3815.jpg)

点击发送验证码。

![](images/image-3816.jpg)

提示发送成功，邮箱里也收到了这个验证码：

![](images/image-3817.jpg)
...
![](images/image-3818.jpg)

修改信息，点击发送验证码：

![](images/image-3819.jpg)

填入验证码，点击修改，提示用户信息更新成功。

去数据库里看一下：

![](images/image-3820.jpg)
