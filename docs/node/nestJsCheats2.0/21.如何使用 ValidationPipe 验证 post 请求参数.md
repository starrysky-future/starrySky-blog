...
![](images/image-634.jpg)

替换为我们自己实现的 MyValidationPipe。

再次请求下：

![](images/image-635.jpg)
...
![](images/image-646.jpg)

在 postman 里发送 post 请求。

![](images/image-647.jpg)
...
![image.png](images/image.png-648.jpg)

这个错误消息也是可以定制的：

![image.png](images/image.png-649.jpg)

添加一个 options 对象，传入 message 函数，打印下它的参数：

![image.png](images/image.png-650.jpg)
