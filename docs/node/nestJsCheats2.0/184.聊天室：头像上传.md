...
![](images/image-5758.jpg)

跑起来之后，访问下 http://localhost:9001

输入用户名密码后点击登录：

![](images/image-5759.jpg)

创建个 bucket：

![](images/image-5760.jpg)

设置下可以公开访问：

![](images/image-5761.jpg)

![](images/image-5762.jpg)

然后上传个文件：

![](images/image-5763.jpg)

![](images/image-5764.jpg)

浏览器访问下这个路径：

http://localhost:9000/chat-room/dong.png

![](images/image-5765.jpg)

这样，文件就上传到了 OSS 里的 bucket，并且能够访问了。

然后我们直接前端直传 minio 就好了：

![](images/image-5766.jpg)
...
![](images/image-5768.jpg)

![](images/image-5769.jpg)
...
![](images/image-5773.jpg)

不过现在 action 的路径不对，我们改一下：

![](images/image-5774.jpg)
...
![](images/image-5775.jpg)

提示上传成功。

在 minio 管理界面也可以看到这个文件：

![](images/image-5776.jpg)

输入验证码，点击修改，会提示更新成功：

![](images/image-5777.jpg)

去数据库里看下：

![](images/image-5778.jpg)
...
![](images/image-5779.jpg)

首先，用户信息更新完后，同步修改下 localStorage 里的 userInfo

![](images/image-5780.jpg)
