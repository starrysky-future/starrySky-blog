...
![](images/image-1830.jpg)

应用启动的时候，我们指定了端口：

![](images/image-1831.jpg)
...
![](images/image-1834.jpg)

如果你手动置顶了环境变量，那以手动指定的优先：

![](images/image-1835.jpg)
...
![](images/image-1841.jpg)

在 Controller 里取出来：

![](images/image-1842.jpg)

浏览器访问下：

![](images/image-1843.jpg)
...
![](images/image-1844.jpg)

同样，前面覆盖后面的。

改下 Controller：

![](images/image-1845.jpg)

浏览器访问下：

![](images/image-1846.jpg)
...
![](images/image-1847.jpg)

在 BbbModule 里注入下：

![](images/image-1848.jpg)

跑起来你会发现报错了：

![](images/image-1849.jpg)

这个模块找不到 ConfigModule。

这时候把 ConfigModule.forRoot 注册为全局模块就好了：

![](images/image-1850.jpg)

这样就可以在 BbbModule 读取到配置了：

![](images/image-1851.jpg)
...
![](images/image-1854.jpg)

之后动态返回模块定义：

![](images/image-1855.jpg)
