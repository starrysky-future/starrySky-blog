...
![](images/image-4930.jpg)

生成了 .env 和 schema 文件：

![](images/image-4931.jpg)

然后改下 .env 文件的数据库连接信息：

![](images/image-4932.jpg)
...
![](images/image-4935.jpg)

生成了 client 代码，还有 sql 文件。

![](images/image-4936.jpg)

数据库中也多了这 2 个表：

![](images/image-4937.jpg)

![](images/image-4938.jpg)
...
![](images/image-4940.jpg)

在 mysql workbench 里看下结果：

![](images/image-4941.jpg)

![](images/image-4942.jpg)

确实，数据都被正确插入了。

当然，你也可以用这种写法：

![](images/image-4943.jpg)
...
![](images/image-4944.jpg)

效果一样：

![](images/image-4945.jpg)

![](images/image-4946.jpg)
...
![](images/image-4953.jpg)

跑一下：

![](images/image-4954.jpg)

刷新可以看到，id 为 4 的 employee 关联的 department 就变了：

![](images/image-4955.jpg)
...
![](images/image-4956.jpg)

![](images/image-4957.jpg)

第二次跑，就是 update 了：

![](images/image-4958.jpg)

也就是说，update 的时候可以通过 create、connect、connectOrCreate 来插入新的关联 model 的记录或者关联已有的记录。

当然，create 的时候也可以这样：

![](images/image-4959.jpg)
...
![](images/image-4960.jpg)

![](images/image-4961.jpg)
