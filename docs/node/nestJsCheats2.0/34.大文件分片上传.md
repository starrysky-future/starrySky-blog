...
![](images/image-923.jpg)

在 AppController 添加一个路由：

![](images/image-924.jpg)
...
![](images/image-926.jpg)

浏览器访问下：

![](images/image-927.jpg)

选择几个文件：

![](images/image-928.jpg)

这时候，Nest 服务端就接收到了上传的文件和其他字段：

![](images/image-929.jpg)
...
![](images/image-930.jpg)

所以每 20k 一个分片，一共是 4 个分片。

测试下：

![](images/image-931.jpg)

服务端接收到了这 4 个分片:

![](images/image-932.jpg)
...
![](images/image-936.jpg)

这样就不会冲突了：

![](images/image-937.jpg)
...
![](images/image-938.jpg)

可以看到，合并成功了：

![](images/image-939.jpg)

再测试一个：

![](images/image-940.jpg)

![](images/image-941.jpg)

也没啥问题。

然后我们在合并完成之后把 chunks 目录删掉。

![](images/image-942.jpg)
