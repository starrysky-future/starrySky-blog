...
执行它：
![](images/image-1462.jpg)

点击刷新，就可以看到这个 database（也叫 schema）了：

![](images/image-1463.jpg)
...
![](images/image-1466.jpg)

执行建表 sql:

![](images/image-1467.jpg)

点击刷新，就可以看到这三个表了：

![](images/image-1468.jpg)
...
![](images/image-1470.jpg)

```sql
select * from orders
```

![](images/image-1471.jpg)

```sql
select * from order_items
```

![](images/image-1472.jpg)
...
![](images/image-1484.jpg)

再查询下：

![](images/image-1485.jpg)
