...
![](images/image-1652.jpg)

把 index.ts 的代码去掉：

![](images/image-1653.jpg)

然后 npm run start

可以看到它生成了两个 Entity 的建表 sql：

![](images/image-1654.jpg)

然后把这两个表删掉，我们来添加多对多的关联关系：

![](images/image-1655.jpg)

在 Entity 里通过 @ManyToMany 关联。

比如一篇文章可以有多个标签：

![](images/image-1656.jpg)

然后再 npm run start

![](images/image-1657.jpg)
...
![](images/image-1659.jpg)

可以看到，3 个标签、2 篇文章，还有两者的关系，都插入成功了。

![](images/image-1660.jpg)

![](images/image-1661.jpg)

![](images/image-1662.jpg)
