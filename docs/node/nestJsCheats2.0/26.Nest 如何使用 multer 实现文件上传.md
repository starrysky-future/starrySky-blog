...
![](images/image-760.jpg)

然后来写前端代码。

之前我们用过这种方式：

![](images/image-761.jpg)

就是让 nest 服务支持静态文件的访问。

现在我们换种方式，让 nest 服务支持跨域，再单独跑个 http-server 来提供静态服务：

![](images/image-762.jpg)

![](images/image-763.jpg)
...
![](images/image-764.jpg)

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](images/image-765.jpg)
...
![](images/image-767.jpg)

后端收到了上传的 aaa、bbb 的文件：

![](images/image-768.jpg)
...
![](images/image-770.jpg)

![](images/image-771.jpg)
...
![](images/image-780.jpg)

然后访问下：

![](images/image-781.jpg)
...
![](images/image-782.jpg)

可以看到，返回的也是 400 响应，并且 message 说明了具体的错误信息。

而且这个错误信息可以自己修改：

![](images/image-783.jpg)

![](images/image-784.jpg)
...
![](images/image-785.jpg)

在浏览器上传个文件：

![](images/image-786.jpg)
