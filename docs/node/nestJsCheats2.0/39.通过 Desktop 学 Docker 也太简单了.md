...
![](images/image-1074.jpg)

这也是为什么它的 logo 是这样的：

![](images/image-1075.jpg)

Docker 提供了 Docker Hub 镜像仓库，可以把本地镜像 push 到仓库或者从仓库 pull 镜像到本地。

![](images/image-1076.jpg)
...
![](images/image-1077.jpg)

它内置了 docker 命令。

把它安装到系统之后，可以在命令行看下 docker 命令是否可用：

![](images/image-1078.jpg)

![](images/image-1079.jpg)

如果不可用，那要设置下这个：

![](images/image-1080.jpg)
...
![](images/image-1081.jpg)

![](images/image-1082.jpg)
...
![](images/image-1092.jpg)

我们再在本地添加一个文件：

![](images/image-1093.jpg)

你会发现容器内这个目录内容也变了：

![](images/image-1094.jpg)

这就是 volume 挂载的作用。

如果你挂载某些目录报错，是因为 docker desktop 挂载的目录是需要配置的，在 Settings > Resources > File Sharing 里加一下就行：

![](images/image-1095.jpg)

至于挂载到的目录，在镜像搜索结果页有写：

![](images/image-1096.jpg)
...
![](images/image-1099.jpg)

docker run 会返回一个容器的 hash：

![](images/image-1100.jpg)

就是这里的 id：

![](images/image-1101.jpg)

这个界面可以用 docker ps 来获取：

![](images/image-1102.jpg)

它是显示容器列表的，默认是运行中的。

想显示全部的，可以加个 -a

![](images/image-1103.jpg)

除了 container 列表，image 镜像列表也可以通过 docker images 命令获取：

![](images/image-1104.jpg)

我们在容器的 terminal 里执行命令，对应的是 docker exec 命令：

![](images/image-1105.jpg)

![](images/image-1106.jpg)
...
![](images/image-1107.jpg)

![](images/image-1108.jpg)

输入 exit 退出：

![](images/image-1109.jpg)

docker inspect 可以查看容器的详情

![](images/image-1110.jpg)

对应 desktop 里的 inspect 的 tab：

![](images/image-1111.jpg)

docker volume 可以管理数据卷：

![](images/image-1112.jpg)

对应 desktop 的这部分：

![](images/image-1113.jpg)
