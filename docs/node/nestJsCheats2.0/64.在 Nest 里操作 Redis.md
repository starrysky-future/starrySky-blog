...
![](images/image-1913.jpg)

最流行的就是 redis 和 ioredis 这两个。

我们创建个项目来试一下：

![](images/image-1914.jpg)
...
![](images/image-1915.jpg)

然后 node 执行下：

![](images/image-1916.jpg)

用 RedisInsight 看下：

![](images/image-1917.jpg)
...
![](images/image-1918.jpg)

所有的 redis 命令都有对应的方法：

![](images/image-1919.jpg)
...
![](images/image-1920.jpg)

其他命令也是这样执行：

![](images/image-1921.jpg)
