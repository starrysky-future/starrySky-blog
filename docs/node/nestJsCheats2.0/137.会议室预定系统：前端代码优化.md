...
![](images/image-4499.jpg)

![](images/image-4500.jpg)

去掉 main.tsx 里的 index.css 和 StrictMode：

![](images/image-4501.jpg)
...
![](images/image-4504.jpg)

memo 里会对比 props 和上次有没有变化，没变就不会重新渲染。

那如果我加一个函数作为参数呢？

![](images/image-4505.jpg)
