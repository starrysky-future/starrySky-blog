...
![](images/image-5674.jpg)

会生成 migration 的 sql 文件，并且会更新 client 代码。

看下生成的 sql：

![](images/image-5675.jpg)

还有生成的表：

![](images/image-5676.jpg)

![](images/image-5677.jpg)
...
![](images/image-5679.jpg)

聊天室创建完成后，单聊把 user 和 friend 加入聊天室，群聊只把 user 加入聊天室。

测试下：

![](images/image-5680.jpg)

sql 没啥问题：

![](images/image-5681.jpg)

看下数据库：

![](images/image-5682.jpg)

![](images/image-5683.jpg)

可以看到，聊天室创建成功，并且有两个人。

再创建个群聊：

![](images/image-5684.jpg)

看下数据库：

![](images/image-5685.jpg)

![](images/image-5686.jpg)
...
![](images/image-5688.jpg)

![](images/image-5689.jpg)

没啥问题。

然后 chatrooms 接口应该返回群聊的用户数，我们实现一下：

![](images/image-5690.jpg)
...
![](images/image-5693.jpg)

![](images/image-5694.jpg)
...
![](images/image-5695.jpg)

![](images/image-5696.jpg)
