...
![](images/image-1164.jpg)

然后在 docker desktop 的 images 里就可以看到这个镜像了：

![](images/image-1165.jpg)
...
![](images/image-1166.jpg)

然后就可以看到容器部分有了这个容器了：

![](images/image-1167.jpg)

浏览器访问 http://localhost:2333 就可以访问容器内跑的这个服务：

![](images/image-1168.jpg)

这就是 Dockerfile 构建成镜像，然后通过容器跑起来的流程。

![](images/image-1169.jpg)
...
![](images/image-1173.jpg)

这次的 tag 为 second。

然后在 docker desktop 里看下：

![](images/image-1174.jpg)

好家伙，足足小了 900M。

我们点开看看：

![](images/image-1175.jpg)
...
![](images/image-1176.jpg)

docker desktop 可以看到这个跑起来的容器：

![](images/image-1177.jpg)

浏览器访问下，依然是正常的：

![](images/image-1178.jpg)
...
![](images/image-1180.jpg)

现在我们改下 README.md：

![](images/image-1181.jpg)

然后重新跑 build：

![](images/image-1182.jpg)

现在花了 25s，其实是没有重新 npm install 的。

然后改下 package.json：

![](images/image-1183.jpg)

再跑 docker build

![](images/image-1184.jpg)

时间明显多了很多，过程中你可以看到在 npm install 那层停留了很长时间。

这就是为什么要这样写：

![](images/image-1185.jpg)
...
![](images/image-1186.jpg)

然后 desktop 里看下构建出来的镜像：

![](images/image-1187.jpg)

镜像体积比没有用多阶段构建的时候小了 250 M。

然后跑起来试试看：

![](images/image-1188.jpg)

这次映射 2335 端口到容器内的 3000 端口。

依然能正常访问：

![](images/image-1189.jpg)
...
![](images/image-1191.jpg)

点击查看镜像详情，可以看到 ARG 已经被替换为具体的值了：

![](images/image-1192.jpg)

![](images/image-1193.jpg)
...
![](images/image-1195.jpg)

其实还可以写成 ENTRYPOINT：

![](images/image-1196.jpg)
...
![](images/image-1198.jpg)

没有指定 --name 时，会生成一个随机容器名。

就是这种：

![](images/image-1199.jpg)
...
![](images/image-1208.jpg)

可以看到，ADD 把 tar.gz 给解压然后复制到容器内了。

![](images/image-1209.jpg)

而 COPY 没有解压，它把文件整个复制过去了：

![](images/image-1210.jpg)

![](images/image-1211.jpg)
