...
![](images/image-2884.jpg)

把 AaaService 导出：

![](images/image-2885.jpg)
...
![](images/image-2886.jpg)

上节我们定时把 redis 数据刷入数据库就是这样做的。

我们设置的每 5s 执行一次，其实是一个 cron 表达式：

![](images/image-2887.jpg)

cron 表达式有这 7 个字段：

![](images/image-2888.jpg)
...
![](images/image-2897.jpg)

这样看不方便，我们加一下调试配置：

![](images/image-2898.jpg)

![](images/image-2899.jpg)
...
![](images/image-2900.jpg)

把之前的服务停掉，点击 debug 启动：

![](images/image-2901.jpg)

代码会在断点处断住：

![](images/image-2902.jpg)
...
![](images/image-2903.jpg)

再根据名字拿到具体的 interval 定时任务：

![](images/image-2904.jpg)
...
![](images/image-2908.jpg)

当然，还可以动态添加定时任务：

![](images/image-2909.jpg)
