...
![](images/image-4116.jpg)

对应的路由我们前面写过了：

![](images/image-4117.jpg)
...
![](images/image-4118.jpg)

根据这个指定表格列的定义，并且添加分页的处理。

其中涉及到的 User 和 Room 的类型从其他页面导入：

![](images/image-4119.jpg)

![](images/image-4120.jpg)

![](images/image-4121.jpg)
...
![](images/image-4124.jpg)

数据库里就这 4 条记录：

![](images/image-4125.jpg)

然后带上参数搜索下：

![](images/image-4126.jpg)

![](images/image-4127.jpg)

![](images/image-4128.jpg)

开始时间在 2023-9-29 的 10 点到 11 点的预定有 3 条：

![](images/image-4129.jpg)

11 点到 12 点的有 1 条：

![](images/image-4130.jpg)

这样，列表功能就完成了。

可以再加上个按照状态过滤，这个是 antd 的功能：

![](images/image-4131.jpg)
...
![](images/image-4132.jpg)

![](images/image-4133.jpg)

然后加上右边的按钮：

![](images/image-4134.jpg)
...
![](images/image-4135.jpg)

![](images/image-4136.jpg)
