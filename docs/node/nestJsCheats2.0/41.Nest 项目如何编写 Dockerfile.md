...
![](images/image-1140.jpg)

然后就可以在 docker desktop 里看到你构建出来的镜像了：

![](images/image-1141.jpg)

如果你 build 的时候报这个错误：

![](images/image-1142.jpg)
...
![](images/image-1143.jpg)

点击 run 把它跑起来：

![](images/image-1144.jpg)

容器跑成功了：

![](images/image-1145.jpg)

浏览器访问下也没啥问题：

![](images/image-1146.jpg)
...
![](images/image-1148.jpg)

把之前的容器停掉，把这个跑起来：

![](images/image-1149.jpg)

这次用 3003 端口来跑：

![](images/image-1150.jpg)

![](images/image-1151.jpg)

浏览器访问下：
![](images/image-1152.jpg)

nest 服务跑成功了。

这时候 app 下就是有 dist 的文件、生产阶段的 node_modules、package.json 这些文件：

![](images/image-1153.jpg)

对比下镜像体积，明显看出有减小，少的就是 src、test、构建阶段的 node_modules 这些文件：

![](images/image-1154.jpg)
...
![](images/image-1155.jpg)

可以看到现在镜像体积只有 277M 了：

![](images/image-1156.jpg)

一般情况下，我们都会用多阶段构建 + alpine 基础镜像。

![](images/image-1157.jpg)
