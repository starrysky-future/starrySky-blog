...
![](images/image-4726.jpg)

这样，就有了两个 nest 的 application：

![](images/image-4727.jpg)

改下 grpc-server 的启动端口号为 3001:

![](images/image-4728.jpg)
...
![](images/image-4729.jpg)

![](images/image-4730.jpg)

浏览器访问下：

![](images/image-4731.jpg)

![](images/image-4732.jpg)
...
![](images/image-4734.jpg)

安装之后就有语法高亮了：

![](images/image-4735.jpg)
...
![](images/image-4741.jpg)

然后在 AppController 里实现调用远程方法的逻辑：

![](images/image-4742.jpg)
...
![](images/image-4743.jpg)

![](images/image-4744.jpg)

可以看到，远程方法调用成功了。

这就是基于 grpc 的远程方法调用，用 java、python、go、c++ 等实现的微服务也是这样来通信。

![](images/image-4745.jpg)
...
![](images/image-4746.jpg)

然后也是定义这样的 proto 文件：

![](images/image-4747.jpg)

之后定义对应的 servie：

![](images/image-4748.jpg)
