...
![](images/image-1309.jpg)

![](images/image-1310.jpg)
...
![](images/image-1311.jpg)

然后执行建表 sql：

![](images/image-1312.jpg)
...
![](images/image-1314.jpg)

插入了这样 18 条数据：

![](images/image-1315.jpg)
...
![](images/image-1330.jpg)

过滤之后是这样：

![](images/image-1331.jpg)
...
![](images/image-1332.jpg)

这时候可以用 distinct 去重：

![](images/image-1333.jpg)
...
![](images/image-1338.jpg)

```sql
SELECT name, score, CASE WHEN score >=90 THEN '优秀' WHEN score >=60 THEN '良好'ELSE '差' END AS '档次' FROM student;
```

![](images/image-1339.jpg)
...
![](images/image-1345.jpg)

```sql
select greatest(1, cast('123' as signed),3);
```

![](images/image-1346.jpg)
