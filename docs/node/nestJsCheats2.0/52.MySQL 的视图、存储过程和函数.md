...
![](images/image-1504.jpg)

刷新就可以看到这个刚创建的存储过程：

![](images/image-1505.jpg)

点击第二个图标就可以传参数调用：

![](images/image-1506.jpg)
...
![](images/image-1508.jpg)

之后之后再创建 function：

![](images/image-1509.jpg)

创建成功之后就可以在 sql 里用它了：

![](images/image-1510.jpg)
...
![](images/image-1512.jpg)

你也可以可视化的调用这个 function：

![](images/image-1513.jpg)
...
![](images/image-1514.jpg)

我们自己来算算对不对：

![](images/image-1515.jpg)

id 为 3 的订单的总额是对的：

![](images/image-1516.jpg)
