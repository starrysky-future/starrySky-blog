...
![](images/image-4209.jpg)

然后分别跑 mysql-container 和 redis-container 容器：

![](images/image-4210.jpg)

最后可以看到 nest-app 也跑起来了：

![](images/image-4211.jpg)

访问下接口：

![](images/image-4212.jpg)

![](images/image-4213.jpg)
...
![](images/image-4214.jpg)

接下来把本地代码 push 到 gitlab 或者 github：

![](images/image-4215.jpg)

然后在服务器上把它拉下来跑下 docker compose up 就行了。

我们买个服务器：

![](images/image-4216.jpg)

![](images/image-4217.jpg)

![](images/image-4218.jpg)
...
![](images/image-4219.jpg)

点击远程连接：

![](images/image-4220.jpg)

点立即登录。

我们用 ssh 密钥的方式登录，这里需要一个密钥文件：

![](images/image-4221.jpg)

在这里创建：

![](images/image-4222.jpg)

创建完会自动下载密钥文件：

![](images/image-4223.jpg)

然后点击绑定密钥对，也就是用这个密钥来登录的服务器：

![](images/image-4224.jpg)

这一步会重启服务器。

然后再次远程连接，就可以用这个密钥文件来登录了:

![](images/image-4225.jpg)
...
![](images/image-4226.jpg)

![](images/image-4227.jpg)
...
![](images/image-4228.jpg)

进入项目目录，跑下 docker compose 就行：

![](images/image-4229.jpg)
...
![](images/image-4230.jpg)

![](images/image-4231.jpg)

![](images/image-4232.jpg)

docker 安装好了，设置下开机启动，也是复制文档的命令就行：

![](images/image-4233.jpg)

![](images/image-4234.jpg)

然后安装 docker compose，同样是直接复制：

![](images/image-4235.jpg)

![](images/image-4236.jpg)
...
![](images/image-4237.jpg)

会先 pull mysql 和 redis 的镜像，然后 build nest 的镜像。

之后就把服务跑起来了：

![](images/image-4238.jpg)

过程中可以看到，会自动创建一系列的 table：

![](images/image-4239.jpg)

因为我们现在还没关掉 synchronize。

因为我们服务跑在 3005 端口，需要在安全组添加一下这个端口：

![](images/image-4240.jpg)

![](images/image-4241.jpg)

然后就可以用公网 ip 访问了：

![](images/image-4242.jpg)

![](images/image-4243.jpg)

![](images/image-4244.jpg)
