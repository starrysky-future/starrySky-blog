...
![](images/image-4031.jpg)

现在，用户端首页是这样的：

![](images/image-4032.jpg)

需要在 / 下添加一个二级路由：

![](images/image-4033.jpg)
...
![](images/image-4053.jpg)

接下来是 update 接口：

他有两种响应：

![](images/image-4054.jpg)

分别写一下：
![](images/image-4055.jpg)
...
![](images/image-4056.jpg)

因为 update 的 dto 继承了 create 的 dto，所以那里也要加一下：

![](images/image-4057.jpg)

这样 swagger 文档就对了：

![](images/image-4058.jpg)

然后是 create 接口：

postman 里调用下是这样的：

![](images/image-4059.jpg)

![](images/image-4060.jpg)

所以 swagger 装饰器这样写：

![](images/image-4061.jpg)
...
![](images/image-4062.jpg)

然后还有最后一个 list 接口：

![](images/image-4063.jpg)

它的响应是这样的：

![](images/image-4064.jpg)
...
![](images/image-4066.jpg)

![](images/image-4067.jpg)

最后，在 controller 上加上个 @ApiTags，把下面的接口分到单独一组：

![](images/image-4068.jpg)

![](images/image-4069.jpg)
