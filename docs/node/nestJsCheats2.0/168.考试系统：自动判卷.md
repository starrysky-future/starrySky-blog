...
![2024-08-27 16.14.41.gif](images/2024-08-27 16.14.41.gif-5381.jpg)

这节来写一下。

我们现在并没有做分数的计算：

![image.png](images/image.png-5382.jpg)
...
![image.png](images/image.png-5383.jpg)

![image.png](images/image.png-5384.jpg)

改下 AnswerService 的 add 方法：

![image.png](images/image.png-5385.jpg)
...
![2024-08-27 17.34.37.gif](images/2024-08-27 17.34.37.gif-5386.jpg)

每种类型问题添加一个：

![2024-08-27 17.36.09.gif](images/2024-08-27 17.36.09.gif-5387.jpg)

点击保存后，去答卷：

![2024-08-27 17.42.38.gif](images/2024-08-27 17.42.38.gif-5388.jpg)

可以看到，计算出的分数是对的：

![image.png](images/image.png-5389.jpg)

然后我们写下结果页面，显示下分数：

![image.png](images/image.png-5390.jpg)
...
![image.png](images/image.png-5391.jpg)
...
![image.png](images/image.png-5392.jpg)

根据 id 查询答卷，设置 score。

并且根据 examId 查询下试卷：

![](images/image-5393.jpg)

渲染 json 的逻辑和编辑器一样，只不过 value 直接指定为正确答案：

![image.png](images/image.png-5394.jpg)
...
![image.png](images/image.png-5395.jpg)

没啥问题。

我们整体试一下：

![2024-08-27 18.07.53.gif](images/2024-08-27 18.07.53.gif-5396.jpg)
