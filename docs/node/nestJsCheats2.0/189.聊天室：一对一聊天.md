...
![](images/image-5890.jpg)

这节就来实现下进入聊天的入口。

也就是这两个：

![](images/image-5891.jpg)

点击聊天按钮的时候，要创建聊天室，或者查找已有的聊天室，然后带着 id 跳到聊天页面：

![](images/image-5892.jpg)

聊天页面选中 id 对应的聊天室。

给聊天按钮加一个点击事件，点击的时候传入对应用户的 id：

![](images/image-5893.jpg)
...
![](images/image-5894.jpg)

现在没这个接口，我们加一下：

![](images/image-5895.jpg)
...
![](images/image-5896.jpg)

现在只有这两个用户在一个聊天室。

结果是对的：

![](images/image-5897.jpg)
...
![](images/image-5898.jpg)

在组件里调用下：

![](images/image-5899.jpg)
...
![](images/image-5903.jpg)

现在，聊天室名字就和平时用的聊天软件一样了。

我们登录神说要有光账号聊聊天：

![](images/image-5904.jpg)

![](images/image-5905.jpg)
...
![](images/image-5906.jpg)

登录，添加光为好友：

![](images/image-5907.jpg)

光这边可以看到这个好友请求，同意之后就可以在好友列表看到了：

![](images/image-5908.jpg)

然后回到小黄鸭这边：

![](images/image-5909.jpg)

可以看到好友申请已经通过，可以在好友列表看到光，然后进入聊天：

![](images/image-5910.jpg)
