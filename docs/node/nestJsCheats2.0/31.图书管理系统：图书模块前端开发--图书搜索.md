...
![](images/image-864.jpg)

![](images/image-865.jpg)
...
![](images/image-866.jpg)

![](images/image-867.jpg)

看下效果：

![](images/image-868.jpg)

然后我们在 interfaces/index.ts 里加下图书列表的请求：

![](images/image-869.jpg)
...
![](images/image-870.jpg)

![](images/image-871.jpg)
...
![](images/image-872.jpg)

可以看到，图书列表加载并渲染了出来。

然后来实现下搜索，之前的 list 接口没支持搜索，我们改造下：

![](images/image-873.jpg)
...
![](images/image-875.jpg)

传 name=西 时：
![](images/image-876.jpg)

传 name=水 时：
![](images/image-877.jpg)

然后我们在前端代码里调用下：

![](images/image-878.jpg)
