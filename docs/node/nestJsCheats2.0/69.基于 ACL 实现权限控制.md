...
![image.png](/nestjsCheats/image.png-2020.jpg)

但有的接口，不只需要登录，可能还需要一定的权限，这时就需要鉴权（Authorization）。

比如管理员登录后，可以调用用户管理的接口，但普通用户登录后就不可以。

![image.png](/nestjsCheats/image.png-2021.jpg)
...
![](/nestjsCheats/image-2023.jpg)

刷新可以看到这个 database：

![](/nestjsCheats/image-2024.jpg)
...
![image.png](/nestjsCheats/image.png-2027.jpg)
...
![](/nestjsCheats/image-2029.jpg)

可以看到生成了 user、permission、user_permission_relation 这 3 个表。

并且中间表 user_permission_relation 还有 userId、permissionId 两个外键。

![image.png](/nestjsCheats/image.png-2030.jpg)

![image.png](/nestjsCheats/image.png-2031.jpg)

![image.png](/nestjsCheats/image.png-2032.jpg)

![image.png](/nestjsCheats/image.png-2033.jpg)
...
![](/nestjsCheats/image-2034.jpg)

服务端打印了一堆 sql，包了一层事务：

![](/nestjsCheats/image-2035.jpg)
...
![](/nestjsCheats/image-2036.jpg)

user 表插入了 2 条用户记录：

![](/nestjsCheats/image-2037.jpg)

中间表插入了 8 条记录，两个用户各拥有 4 个权限：

![](/nestjsCheats/image-2038.jpg)
...
![](/nestjsCheats/image-2039.jpg)

然后在 postman 里测试下：

ValidationPipe 不通过的时候，会返回错误信息：

![](/nestjsCheats/image-2040.jpg)

ValidationPipe 通过之后，就会执行 handler 里的方法：

![](/nestjsCheats/image-2041.jpg)

![](/nestjsCheats/image-2042.jpg)
...
用户不存在：
![image.png](/nestjsCheats/image.png-2043.jpg)

密码错误：

![image.png](/nestjsCheats/image.png-2044.jpg)

登录成功：
![image.png](/nestjsCheats/image.png-2045.jpg)

![image.png](/nestjsCheats/image.png-2046.jpg)
...
![image.png](/nestjsCheats/image.png-2047.jpg)

![image.png](/nestjsCheats/image.png-2048.jpg)

现在这些接口可以直接访问：

![image.png](/nestjsCheats/image.png-2049.jpg)

![image.png](/nestjsCheats/image.png-2050.jpg)
...
![image.png](/nestjsCheats/image.png-2051.jpg)

利用同名 interface 会自动合并的特点来扩展 Session。

然后给接口都加上这个 Guard：

![image.png](/nestjsCheats/image.png-2052.jpg)

![image.png](/nestjsCheats/image.png-2053.jpg)

再访问下：

![image.png](/nestjsCheats/image.png-2054.jpg)

![image.png](/nestjsCheats/image.png-2055.jpg)

在 postman 里带上 cookie 访问：

![image.png](/nestjsCheats/image.png-2056.jpg)

你访问登录接口之后，服务端返回 set-cookie 的 header，postman 会自动带上 cookie，不需要手动带：

![image.png](/nestjsCheats/image.png-2057.jpg)

行为和浏览器里一致。

这时候再访问 aaa、bbb 的接口，就可以访问了：

![image.png](/nestjsCheats/image.png-2058.jpg)

![image.png](/nestjsCheats/image.png-2059.jpg)
...
![image.png](/nestjsCheats/image.png-2060.jpg)
...
![](/nestjsCheats/image-2061.jpg)

然后在 /aaa 的 handler 里添加 PermissionGuard：

![image.png](/nestjsCheats/image.png-2062.jpg)

postman 访问下：

首先重新登录，post 方式请求 /user/login：

![image.png](/nestjsCheats/image.png-2063.jpg)

然后 get 访问 /aaa，postman 会自动带上 cookie。

![image.png](/nestjsCheats/image.png-2064.jpg)

服务端打印了 UserService：

![image.png](/nestjsCheats/image.png-2065.jpg)
...
![](/nestjsCheats/image-2066.jpg)

然后请求 /aaa 接口：

![](/nestjsCheats/image-2067.jpg)

服务端打印了当前用户的权限信息：

![](/nestjsCheats/image-2068.jpg)
...
![](/nestjsCheats/image-2071.jpg)
访问 /aaa，会提示没有权限：

![image.png](/nestjsCheats/image.png-2072.jpg)

然后登录东东的账号：

![](/nestjsCheats/image-2073.jpg)

然后访问 /aaa：

![](/nestjsCheats/image-2074.jpg)
...
![image.png](/nestjsCheats/image.png-2075.jpg)
...
![image.png](/nestjsCheats/image.png-2076.jpg)
...
![image.png](/nestjsCheats/image.png-2077.jpg)
...
![image.png](/nestjsCheats/image.png-2078.jpg)
...
![image.png](/nestjsCheats/image.png-2079.jpg)

然后先登录：

![image.png](/nestjsCheats/image.png-2080.jpg)

服务端打印了查询用户数据的 sql：

![image.png](/nestjsCheats/image.png-2081.jpg)

然后再访问 /aaa

![image.png](/nestjsCheats/image.png-2082.jpg)

又打印了 2 条关联查询的 sql：

![image.png](/nestjsCheats/image.png-2083.jpg)

我们去 RedisInsight 里看下：

![image.png](/nestjsCheats/image.png-2084.jpg)

可以看到这条缓存。

这时候你刷新多少次，都不会再产生 sql 了：

![2023-06-22 17.16.43.gif](/nestjsCheats/2023-06-22 17.16.43.gif-2085.jpg)
