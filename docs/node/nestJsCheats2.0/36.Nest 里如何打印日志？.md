...
![](images/image-1007.jpg)

刷新页面打印的日志是这样的：

![](images/image-1008.jpg)
...
![](images/image-1009.jpg)

这样你没重写的方法就是原来的：

![](images/image-1010.jpg)

这就是创建应用时 logger 的 3 种取值：

![](images/image-1011.jpg)
...
![](images/image-1013.jpg)

通过 @Inject 注入 AppService，并在 log 的时候调用。

现在的日志是这样的：

![](images/image-1014.jpg)
...
![](images/image-1016.jpg)

在这个模块里可以直接注入 MyLogger，不用 imports 那个 Module。

![](images/image-1017.jpg)

测试下：

![](images/image-1018.jpg)

![](images/image-1019.jpg)
...
![](images/image-1020.jpg)

![](images/image-1021.jpg)

每次 imports 的时候传入不同的配置：

![](images/image-1022.jpg)
