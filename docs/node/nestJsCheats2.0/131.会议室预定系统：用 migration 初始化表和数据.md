...
![](images/image-4296.jpg)

![](images/image-4297.jpg)

这样每个表一个 sql 文件：

![](images/image-4298.jpg)

我们选择第二个选项，重新导出下：

![](images/image-4299.jpg)

![](images/image-4300.jpg)

这样就都集中到一个 sql 文件里了。

打开这个生成的 sql 文件看下：

![](images/image-4301.jpg)

包含了所有的表的 create table 和 insert into 语句。

然后我们在项目的 package.json 里加一下 migration 的 npm scripts：

![](images/image-4302.jpg)
...
![](images/image-4305.jpg)

![](images/image-4306.jpg)

这时候没什么更改：

![](images/image-4307.jpg)

因为 entity 和数据库表是同步的。

我们把数据表给删掉：

![](images/image-4308.jpg)
...
![](images/image-4309.jpg)

里面包含的自然就是所有表的 create table 语句：

![](images/image-4310.jpg)
...
![](images/image-4311.jpg)

数据库里也有了这些表：

![](images/image-4312.jpg)

并且在 migrations 表里记录了这个 migration 的执行记录：

![](images/image-4313.jpg)
...
![](images/image-4314.jpg)

这次我们自己来填 sql：

![](images/image-4315.jpg)
...
![](images/image-4316.jpg)

也就是列的顺序对不上。

因为 sql 文件里的顺序是这样的：

![](images/image-4317.jpg)

第 6、7 列是 userId、roomId，和 insert into 语句对应。

而现在第 6 列是 createTime：

![](images/image-4318.jpg)
...
![](images/image-4323.jpg)

执行成功了！

在数据库看下：

![](images/image-4324.jpg)

![](images/image-4325.jpg)

数据都插入成功了，并且 migrations 表也记录了这次的执行记录：

![](images/image-4326.jpg)
