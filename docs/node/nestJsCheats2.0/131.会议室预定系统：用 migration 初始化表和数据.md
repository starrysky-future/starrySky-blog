...
![](/nestjsCheats/image-4296.jpg)

![](/nestjsCheats/image-4297.jpg)

这样每个表一个 sql 文件：

![](/nestjsCheats/image-4298.jpg)

我们选择第二个选项，重新导出下：

![](/nestjsCheats/image-4299.jpg)

![](/nestjsCheats/image-4300.jpg)

这样就都集中到一个 sql 文件里了。

打开这个生成的 sql 文件看下：

![](/nestjsCheats/image-4301.jpg)

包含了所有的表的 create table 和 insert into 语句。

然后我们在项目的 package.json 里加一下 migration 的 npm scripts：

![](/nestjsCheats/image-4302.jpg)
...
![](/nestjsCheats/image-4305.jpg)

![](/nestjsCheats/image-4306.jpg)

这时候没什么更改：

![](/nestjsCheats/image-4307.jpg)

因为 entity 和数据库表是同步的。

我们把数据表给删掉：

![](/nestjsCheats/image-4308.jpg)
...
![](/nestjsCheats/image-4309.jpg)

里面包含的自然就是所有表的 create table 语句：

![](/nestjsCheats/image-4310.jpg)
...
![](/nestjsCheats/image-4311.jpg)

数据库里也有了这些表：

![](/nestjsCheats/image-4312.jpg)

并且在 migrations 表里记录了这个 migration 的执行记录：

![](/nestjsCheats/image-4313.jpg)
...
![](/nestjsCheats/image-4314.jpg)

这次我们自己来填 sql：

![](/nestjsCheats/image-4315.jpg)
...
![](/nestjsCheats/image-4316.jpg)

也就是列的顺序对不上。

因为 sql 文件里的顺序是这样的：

![](/nestjsCheats/image-4317.jpg)

第 6、7 列是 userId、roomId，和 insert into 语句对应。

而现在第 6 列是 createTime：

![](/nestjsCheats/image-4318.jpg)
...
![](/nestjsCheats/image-4319.jpg)

在输入框粘贴下：

![](/nestjsCheats/image-4320.jpg)

把列名这部分复制出来，调整成正确的顺序然后放到 insert into 的 sql 里：

![](/nestjsCheats/image-4321.jpg)

只有这一个有问题的 insert 语句指定下列名就行，别的 insert 语句不用改。

然后你还可能遇到外键约束的问题：

![](/nestjsCheats/image-4322.jpg)
...
![](/nestjsCheats/image-4323.jpg)

执行成功了！

在数据库看下：

![](/nestjsCheats/image-4324.jpg)

![](/nestjsCheats/image-4325.jpg)

数据都插入成功了，并且 migrations 表也记录了这次的执行记录：

![](/nestjsCheats/image-4326.jpg)
