...
![](images/image-3340.jpg)

后台管理系统一般都会支持从 Excel 导入数据，或者导出数据到 Excel 文件：

![](images/image-3341.jpg)
...
![](images/image-3347.jpg)

所以我们遍历 sheet、row、cell 这几层，就能拿到所有的数据。

跑下看看：

![](images/image-3348.jpg)
...
![](images/image-3355.jpg)

浏览器访问下：

![](images/image-3356.jpg)

可以看到，同样解析出了 excel 的内容。

然后再试试生成 excel：

![image.png](images/image.png-3357.jpg)
...
![](images/image-3360.jpg)

可以看到，生成了 excel 并且触发了下载。

![](images/image-3361.jpg)
