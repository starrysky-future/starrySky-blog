...
![](images/image-5305.jpg)

![](images/image-5306.jpg)
...
![image.png](images/image.png-5307.jpg)
...
![image.png](images/image.png-5308.jpg)
...
![](images/image-5310.jpg)

然后写了一个 renderComponents 方法来渲染它：

![image.png](images/image.png-5311.jpg)

css 如下：

![image.png](images/image.png-5312.jpg)
...
![image.png](images/image.png-5313.jpg)
...
![image.png](images/image.png-5314.jpg)
...
![image.png](images/image.png-5315.jpg)
...
![2024-08-26 17.55.36.gif](images/2024-08-26 17.55.36.gif-5316.jpg)

然后处理 drop：

![image.png](images/image.png-5317.jpg)

accept 是可以接收的 drag 的类型，也就是这个：

![image.png](images/image.png-5318.jpg)
...
![2024-08-26 18.02.46.gif](images/2024-08-26 18.02.46.gif-5319.jpg)
...
![image.png](images/image.png-5320.jpg)
...
![image.png](images/image.png-5321.jpg)

```javascript
<pre>{JSON.stringify(json, null, 4)}</pre>
```

![2024-08-26 22.01.21.gif](images/2024-08-26 22.01.21.gif-5322.jpg)

然后点击问题的时候加一个高亮框：

![image.png](images/image.png-5323.jpg)
...
![2024-08-26 22.03.45.gif](images/2024-08-26 22.03.45.gif-5324.jpg)

然后选中的时候在右边展示对应的编辑表单：

首先把 json 拿进来作为一个 state：

![image.png](images/image.png-5325.jpg)
...
![image.png](images/image.png-5326.jpg)
...
![2024-08-26 22.57.40.gif](images/2024-08-26 22.57.40.gif-5327.jpg)

切换选中的问题的时候，有的表单值没变。

因为我们设置的是 initialValues，它只影响初始值。

![image.png](images/image.png-5328.jpg)
...
![2024-08-26 23.01.49.gif](images/2024-08-26 23.01.49.gif-5329.jpg)

没啥问题。

然后再试下编辑：
![2024-08-26 23.02.39.gif](images/2024-08-26 23.02.39.gif-5330.jpg)

可以看到，选中的问题，会回显在表单，编辑后会同步修改对应 json。

我们再加一个 antd 的 Segmented 组件来做 Tab

![image.png](images/image.png-5331.jpg)
...
![2024-08-26 23.08.21.gif](images/2024-08-26 23.08.21.gif-5332.jpg)
