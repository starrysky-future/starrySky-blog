...
![](images/image-4605.jpg)

那肯定不行，太难维护了。

这时候我们就需要 monorepo 了。

![](images/image-4606.jpg)
...
![](images/image-4607.jpg)

我们添加一个 aaa 的路由：

![](images/image-4608.jpg)
...
![](images/image-4610.jpg)

浏览器访问下：

![](images/image-4611.jpg)
...
![](images/image-4616.jpg)

可以看到，跑的还是之前的那个 nest 项目，只不过换成了 webpack 编译。

![](images/image-4617.jpg)
...
![](images/image-4618.jpg)

现在变成了这样：

![](images/image-4619.jpg)
...
![](images/image-4620.jpg)

比如我在 app2 添加一个 bbb 的路由：

![](images/image-4621.jpg)
...
![](images/image-4629.jpg)

在 controller 里注入 Lib1Service 并调用它的方法：

![](images/image-4630.jpg)
...
![](images/image-4631.jpg)

![](images/image-4632.jpg)
...
![](images/image-4633.jpg)

![](images/image-4634.jpg)

浏览器访问下 http://localhost:3001/aaa 和 http://localhost:3000/bbb

![](images/image-4635.jpg)

![](images/image-4636.jpg)
...
![](images/image-4640.jpg)

之所以 application 或者 library 都能知道输出目录在哪，是因为在 tsconfig.json 里配了：

![](images/image-4641.jpg)

![](images/image-4642.jpg)

![](images/image-4643.jpg)
