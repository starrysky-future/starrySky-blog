...
![](images/image-2468.jpg)

浏览器访问下：

![](images/image-2469.jpg)

看到 hello world 代表 nest 服务跑起来了。

然后改下 AppService：

![](images/image-2470.jpg)

修改下端口：

![](images/image-2471.jpg)

然后再 npm run start：

![](images/image-2472.jpg)

浏览器访问下：

![](images/image-2473.jpg)
...
![](images/image-2479.jpg)

点开看看：

![](images/image-2480.jpg)

这就是本地的那个文件。

我们在本地改一下试试：

![](images/image-2481.jpg)

容器内也同样修改了。

![](images/image-2482.jpg)
