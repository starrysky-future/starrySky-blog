...
![](images/image-3457.jpg)

在 docker desktop 里把 mysql 的容器跑起来：

![](images/image-3458.jpg)
...
![](images/image-3459.jpg)

刷新可以看到这个 database

![](images/image-3460.jpg)

用户模块涉及到这些表：

![](images/image-3461.jpg)

我们创建下它们的 entity：

先在 nest-cli.json 里添加 generateOptions，设置 spec 为 false

![](images/image-3462.jpg)
...
![](images/image-3465.jpg)

我们去数据库看下：

users 表没啥问题：

![](images/image-3466.jpg)
...
![](images/image-3467.jpg)

permissions 表：

![](images/image-3468.jpg)

还有两个中间表：

![](images/image-3469.jpg)

![](images/image-3470.jpg)

![](images/image-3471.jpg)

![](images/image-3472.jpg)
...
![](images/image-3477.jpg)

![](images/image-3478.jpg)
...
![](images/image-3479.jpg)

注册的逻辑是这样的：

![](images/image-3480.jpg)
...
![](images/image-3485.jpg)

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](images/image-3486.jpg)

![](images/image-3487.jpg)

测试下：

带上错误的验证码，返回验证码不正确；

![](images/image-3488.jpg)

带上正确的验证码，返回注册成功：

![](images/image-3489.jpg)

这时可以在数据库里看到这条记录：

![](images/image-3490.jpg)
...
![](images/image-3495.jpg)

邮件发送成功：

![](images/image-3496.jpg)

redis 里也保存了邮箱地址对应的验证码：

![](images/image-3497.jpg)

这样整个注册的流程就完成了。

![](images/image-3498.jpg)
