...
![](images/image-1791.jpg)

然后在 mysql workbench 创建这个 database：

![](images/image-1792.jpg)

![](images/image-1793.jpg)
...
![](images/image-1794.jpg)

可以看到，自动创建了 ariticle 的表。

这就是 syncronize 设为 true 的效果。

![](images/image-1795.jpg)

然后我们添加一些数据：

![](images/image-1796.jpg)
...
![](images/image-1798.jpg)

可以看到，数据插入成功了：

![](images/image-1799.jpg)

![](images/image-1800.jpg)

然后在查询接口里查一下：

![](images/image-1801.jpg)
...
![](images/image-1804.jpg)

![](images/image-1805.jpg)

第一个选项是每个表一个 sql 文件，你也可以选择第二个选项，全部导出一个 sql 文件里：

![](images/image-1806.jpg)

打开看下：

![](images/image-1807.jpg)
...
![](images/image-1809.jpg)

它会对比 entity 和数据表的差异，生成迁移 sql：

![](images/image-1810.jpg)
...
![](images/image-1819.jpg)

![](images/image-1820.jpg)
...
Article 实体加一个 tags 字段：

![](images/image-1821.jpg)
...
![](images/image-1822.jpg)

生成了 alter table 的 sql：

![](images/image-1823.jpg)
...
![](images/image-1827.jpg)

用到 ConfigModule，这个是下节的内容，这里就不展开了：

![](images/image-1828.jpg)
