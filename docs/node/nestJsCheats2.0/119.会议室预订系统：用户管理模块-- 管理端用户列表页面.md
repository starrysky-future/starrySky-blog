...
![](images/image-3857.jpg)

![](images/image-3858.jpg)

![](images/image-3859.jpg)

![](images/image-3860.jpg)
...
![](images/image-3863.jpg)

都没问题。

把 src 目录下其余文件去掉：

![](images/image-3864.jpg)
...
![](images/image-3866.jpg)

![](images/image-3867.jpg)

![](images/image-3868.jpg)

![](images/image-3869.jpg)
都没啥问题。
...
![](images/image-3872.jpg)

然后看一下接口文档 http://localhost:3005/api-doc

![](images/image-3873.jpg)

![](images/image-3874.jpg)

传入用户名、密码、返回用户信息和 token。

在 postman 里测试下登录接口：

![](images/image-3875.jpg)
...
![](images/image-3876.jpg)

提示 400 错误没处理。

因为接口返回 400 的时候，axios 会抛异常：

![](images/image-3877.jpg)

![](images/image-3878.jpg)
...
![](images/image-3879.jpg)

当密码错误时：

![](images/image-3880.jpg)

登录成功时：

![](images/image-3881.jpg)

![](images/image-3882.jpg)
...
![](images/image-3884.jpg)

没啥问题。

不知道同学们有没有发现，其实这个页面应该是三级路由：

![](images/image-3885.jpg)
...
![](images/image-3887.jpg)

然后来写 UserManage 组件：

![](images/image-3888.jpg)
...
![](images/image-3890.jpg)

然后我们调用下搜索接口。

看下接口文档：

![](images/image-3891.jpg)

![](images/image-3892.jpg)

在 postman 里调用下：

![](images/image-3893.jpg)

这个接口是需要登录的。

我们先登录一下：

![](images/image-3894.jpg)

带上 access_token 再访问：
![](images/image-3895.jpg)

![](images/image-3896.jpg)
...
![](images/image-3897.jpg)

测试下：

![](images/image-3898.jpg)

先登录。

然后访问 http://localhost:3000/user_manage

![](images/image-3899.jpg)
...
![](images/image-3901.jpg)

原型图还有个冻结功能：

![](images/image-3902.jpg)

看下接口文档：

![](images/image-3903.jpg)

很简单，就是个 get 接口。

我们在表格里加一列：

![](images/image-3904.jpg)
...
![2023-09-12 11.31.21.gif](images/2023-09-12 11.31.21.gif-3906.jpg)

然后我们还要把冻结状态显示出来：

这部分数据是返回了的：

![](images/image-3907.jpg)

需要添加一列：

![](images/image-3908.jpg)
...
![](images/image-3909.jpg)

测试下：

![](images/image-3910.jpg)
...
![](images/image-3911.jpg)

freeezeUser 也是：

![](images/image-3912.jpg)
...
![](images/image-3913.jpg)

把它添加到 useEffect 的依赖里，这样就能触发重新搜索：

![](images/image-3914.jpg)

测试下：

![](images/image-3915.jpg)

但其实现在这个重新搜索有问题：

![](images/image-3916.jpg)
...
![](images/image-3917.jpg)

然后在搜索的时候拿到最新的表单值：

![](images/image-3918.jpg)
