...
![](images/image-4592.jpg)

然后在 microservice-test-main 里调用下：

![](images/image-4593.jpg)
...
![](images/image-4594.jpg)

![](images/image-4595.jpg)
...
![](images/image-4596.jpg)

安装后把它跑起来：

![](images/image-4597.jpg)

选择 loopback 这个网卡，本地回环地址，可以抓到 localhost 的包：

![](images/image-4598.jpg)

输入过滤器 port 8888，也就是过滤 8888 端口的数据包。

然后回车就会进入抓包界面：

![](images/image-4599.jpg)

这时候再访问下 http://localhost:3000/sum?num=1,2,3

![](images/image-4600.jpg)

可以看到抓到了几个 tcp 的包：

![](images/image-4601.jpg)

点开这几个 PSH 的包看一下：

![](images/image-4602.jpg)

![](images/image-4603.jpg)

![](images/image-4604.jpg)
