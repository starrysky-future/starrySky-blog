...
![](images/image-3121.jpg)

在编辑器上传会提示超过 10 M 了：

![](images/image-3122.jpg)

这时候就需要 GIF 压缩，不然文章发不了。

于是我在百度搜素 GIF 压缩，就找到了一个工具：

![](images/image-3123.jpg)

它确实能解决我的问题：

![](images/image-3124.jpg)

但是要花钱：

![](images/image-3125.jpg)
...
![](images/image-3126.jpg)

但最近发现有 npm 包可以做这个，没必要买这种网站的会员。。。

当时我的心情是这样的：

![](images/image-3127.jpg)

这个 npm 包就是 sharp，它是用来处理各种图片的：

![](images/image-3128.jpg)

![](images/image-3129.jpg)
...
![](images/image-3130.jpg)

要知道之前的 1.image.gif 可是有 21M 啊：

![](images/image-3131.jpg)

然后打开它看看：

![](images/image-3132.jpg)

没啥问题。

回过头来，我们再来看看这段代码：

![](images/image-3133.jpg)
...
![](images/image-3135.jpg)

图片也更小了一些：

![](images/image-3136.jpg)
...
![](images/image-3139.jpg)

antd 会 post 方式请求 action 对应的接口，带上上传的文件：

![](images/image-3140.jpg)
...
![](images/image-3141.jpg)

修改 main.ts，启用跨域支持，并修改启动端口为 3005

![](images/image-3142.jpg)
...
![](images/image-3146.jpg)

测试下上传：

![](images/image-3147.jpg)

提示文件上传成功了，然后在服务端控制台也打印了文件信息，并且在 uploads 目录下可以看到这个文件：

![](images/image-3148.jpg)

这些文件在浏览器打开，可以看到就是上传的 gif：

![](images/image-3149.jpg)

然后我们把文件路径返回就好了：

![](images/image-3150.jpg)

现在上传文件成功之后就可以拿到这个文件在服务端的路径了：

![](images/image-3151.jpg)
...
![](images/image-3152.jpg)

服务端接收到了传过来的参数：

![](images/image-3153.jpg)

然后换一个真实存在的路径，返回 success：

![](images/image-3154.jpg)

说明服务端找到了这个路径的文件：

![](images/image-3155.jpg)
...
![](images/image-3157.jpg)

访问这个接口，带上文件路径和压缩的参数，会返回压缩后的文件：

![](images/image-3158.jpg)

然后我们在前端页面上加一个表单来填参数，然后访问这个接口压缩文件：

![](images/image-3159.jpg)
