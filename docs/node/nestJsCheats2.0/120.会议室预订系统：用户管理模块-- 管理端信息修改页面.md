...
![](images/image-3920.jpg)

![](images/image-3921.jpg)

很明显，它们是和这几个管理页面平级的，点击用户图标的时候打开：

![](images/image-3922.jpg)

所以，我们在它平级添加个路由：

![](images/image-3923.jpg)
...
![](images/image-3924.jpg)

![](images/image-3925.jpg)

没啥问题。

但是现在点击菜单是没反应的，我们给它加上 click 事件。

![](images/image-3926.jpg)
...
![](images/image-3927.jpg)

测试下：

![](images/image-3928.jpg)

点击菜单可以切换路由了。

但现在有个问题，页面一刷新，选中的菜单项就变了：

![](images/image-3929.jpg)

我们需要根据当前路由来决定选中哪个：

![](images/image-3930.jpg)
...
![](images/image-3931.jpg)

改下 Index 组件，添加两个链接：

![](images/image-3932.jpg)
...
渲染出来是这样的：
![](images/image-3935.jpg)

上传功能也是可用的：

![](images/image-3936.jpg)
...
![](images/image-3939.jpg)

改完点击 apply。

然后需要重新登录一遍，因为现在后端会直接从 jwt 里取邮箱地址，重新登录才会更新。

![](images/image-3940.jpg)

邮箱收到了验证码：

![](images/image-3941.jpg)
...
![](images/image-3942.jpg)

修改成功后，刷新页面，可以看到依然是修改后的数据，就代表修改成功了：

![](images/image-3943.jpg)
...
![](images/image-3947.jpg)

这样邮箱地址就会回显，并且只读：

![](images/image-3948.jpg)
...
![](images/image-3949.jpg)

邮箱收到了对应的验证码：

![](images/image-3950.jpg)
然后加上修改密码接口：
...
![](images/image-3951.jpg)

我们可以去登录页面，用老密码试试：

![](images/image-3952.jpg)

再用新密码试试：

![](images/image-3953.jpg)
