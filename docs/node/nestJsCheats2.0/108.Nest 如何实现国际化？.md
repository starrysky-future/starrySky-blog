...
![](images/image-3404.jpg)

浏览器访问下：

![](images/image-3405.jpg)

![](images/image-3406.jpg)

可以看到，文案根据语言环境做了国际化。

![](images/image-3407.jpg)
...
![](images/image-3408.jpg)

![](images/image-3409.jpg)

![](images/image-3410.jpg)

再访问就变成了中文的：

![](images/image-3411.jpg)

有的同学可能问了，现在是用 I18nService 做的翻译，那不在 IoC 容器里的类，怎么翻译呢？

比如 dto：

![](images/image-3412.jpg)
...
![](images/image-3417.jpg)

访问下：

![](images/image-3418.jpg)

可以看到，key 被替换成了具体的文案。

把 cookie 里的 lang 改为 en：

![](images/image-3419.jpg)

![](images/image-3420.jpg)
...
![](images/image-3421.jpg)

![](images/image-3422.jpg)

![](images/image-3423.jpg)
...
![](images/image-3424.jpg)

然后用的时候传入参数：

![](images/image-3425.jpg)
...
![](images/image-3426.jpg)

I18nService 的 api 同样支持这个：

加一下占位符：

![](images/image-3427.jpg)
