...
![](images/image-3032.jpg)

![](images/image-3033.jpg)

或者这个 ai 聊天产品：

![](images/image-3034.jpg)

![](images/image-3035.jpg)
...
![](images/image-3041.jpg)

然后把 react 项目 index.tsx 里这几行代码删掉，它会导致额外的渲染：

![](images/image-3042.jpg)

执行 npm run start

因为 3000 端口被占用了，它会跑在 3001：

![](images/image-3043.jpg)

浏览器访问下：

![](images/image-3044.jpg)
...
![](images/image-3045.jpg)

然后在 EventStream 里可以看到每一次收到的消息：

![](images/image-3046.jpg)
...
![](images/image-3051.jpg)

测试下：

![](images/image-3052.jpg)
...
![](images/image-3053.jpg)

而 Buffer 有个 toJSON 方法：

![](images/image-3054.jpg)
...
![](images/image-3055.jpg)

![](images/image-3056.jpg)
