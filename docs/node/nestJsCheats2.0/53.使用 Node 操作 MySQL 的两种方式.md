...
![](images/image-1518.jpg)

和我们在 mysql workbench 里执行效果一样。

![](images/image-1519.jpg)
...
![](images/image-1522.jpg)

点下刷新，可以看到确实修改了：

![](images/image-1523.jpg)
...
![](images/image-1528.jpg)

回过头来再看看这些 option：

![](images/image-1529.jpg)
...
![](images/image-1530.jpg)

![](images/image-1531.jpg)
...
![](images/image-1534.jpg)

打开看一下：

![](images/image-1535.jpg)

它还有一条数据。

而且控制台也打印了查询出来的这条数据：

![](images/image-1536.jpg)

怎么做到的呢？

我们看下代码，有这样一个 entity，通过装饰器声明了主键列和其他的列：

![](images/image-1537.jpg)

在 index.ts 里创建了一个 User 的对象，调用 save 方法保存这个对象，通过 find 方法查询这个对象：

![](images/image-1538.jpg)
...
![](images/image-1539.jpg)

然后去数据库把那个 user 表删掉。

![](images/image-1540.jpg)

再重新 npm run start：

![](images/image-1541.jpg)
