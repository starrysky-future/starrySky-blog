...
![](images/image-5534.jpg)

浏览器访问下：

![](images/image-5535.jpg)

![](images/image-5536.jpg)
...
![](images/image-5537.jpg)

这两种是等价写法：

![](images/image-5538.jpg)
...
![](images/image-5539.jpg)

再打开一个页面，进入 aaa 房间：

![](images/image-5540.jpg)

这时候之前那个房间就有 2 条消息了：

![](images/image-5541.jpg)

再打开一个页面，进入 bbb 房间，这时候之前的 aaa 房间并没有收到消息：

![](images/image-5542.jpg)
...
![](images/image-5544.jpg)

再打开一个页面：

![](images/image-5545.jpg)

可以看到，另一个页面也收到消息了，因为这俩在一个房间。

我们进入其他房间发消息试试：

![](images/image-5546.jpg)

这时候另外两个页面就没收到消息了：

![](images/image-5547.jpg)
