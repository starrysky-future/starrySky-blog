...
![](images/image-5911.jpg)

其实现在展示的群聊列表有点问题，应该把一对一的聊天室过滤掉，而且把群聊人数显示出来。

我们改一下：
![](images/image-5912.jpg)

![](images/image-5913.jpg)
...
![](images/image-5914.jpg)

然后我们优化下日期展示，加上人数展示，加一个详情按钮：

![](images/image-5915.jpg)
...
![](images/image-5917.jpg)

![](images/image-5918.jpg)
...
![](images/image-5919.jpg)

没啥问题。

其实好友列表那里也应该把 id 和 username 展示出来：

![](images/image-5920.jpg)

![](images/image-5921.jpg)

然后群聊点击聊天的时候可以直接知道 chatroomId，跳到聊天页面：

![](images/image-5922.jpg)
...
![](images/image-5924.jpg)

![](images/image-5925.jpg)
...
![](images/image-5933.jpg)

现在群里有三个成员，我们登录另外两个账号聊聊天试试：

登录小红的账号：

![](images/image-5934.jpg)

确实，她有了这个群聊。

再登录东东的账号聊天试试：

![](images/image-5935.jpg)

没问题，可以三人在房间里聊天。

但现在还有个 bug：

![](images/image-5936.jpg)

点击聊天进入聊天室的时候，并不会查询聊天记录，只有切换聊天室才会。

当解析 state 中的 chatroomId 的时候，再查一下聊天记录就好了：

![](images/image-5937.jpg)
...
![](images/image-5939.jpg)

![](images/image-5940.jpg)
...
![](images/image-5941.jpg)

然后给这个闲聊群加几个成员：

![](images/image-5942.jpg)

![](images/image-5943.jpg)

进入聊天：

![](images/image-5944.jpg)

![](images/image-5945.jpg)

![](images/image-5946.jpg)
...
![](images/image-5947.jpg)

刚加载出聊天记录的时候，不会滚动到底部。

我们也加一下自动滚动：

![](images/image-5948.jpg)
