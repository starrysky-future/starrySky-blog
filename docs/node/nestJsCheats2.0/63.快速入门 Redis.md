...
![](images/image-1857.jpg)

它会让你填一些容器的信息：

![](images/image-1858.jpg)
...
![](images/image-1869.jpg)

输入操作系统信息，还有邮箱、姓名、职业、手机号等信息，就可以下载安装包了。

![](images/image-1870.jpg)

安装后就是这个东西：

![](images/image-1871.jpg)

点击 add database：

![](images/image-1872.jpg)

连接信息用默认的就行：

![](images/image-1873.jpg)

然后就可以看到新建的这个链接：

![](images/image-1874.jpg)

点击它就可以可视化看到所有的 key 和值：

![](images/image-1875.jpg)

同样也可以执行命令：

![](images/image-1876.jpg)

然后我们继续看 list 类型的数据结构：

文档中有这么几个命令：

![](images/image-1877.jpg)
...
![](images/image-1881.jpg)

![](images/image-1882.jpg)

![](images/image-1883.jpg)

lpop 和 rpop 自然是从左边和从右边删除数据。

    lpop list1

![](images/image-1884.jpg)

![](images/image-1885.jpg)

    rpop list1

![](images/image-1886.jpg)

![](images/image-1887.jpg)

![](images/image-1888.jpg)
...
![](images/image-1891.jpg)

刷新之后可以看到它只保留去重后的数据：

![](images/image-1892.jpg)

可以通过 sismember 判断是否是集合中的元素：

    sismember set1 111

![](images/image-1893.jpg)

    sismember set1 444

![](images/image-1894.jpg)

set 只能去重、判断包含，不能对元素排序。

如果排序、去重的需求，比如排行榜，可以用 sorted set，也就是 zset，：

![](images/image-1895.jpg)
...
![](images/image-1896.jpg)

会按照分数来排序：

![](images/image-1897.jpg)

通过 zrange 命令取数据，比如取排名前三的数据：

    zrange zset1 0 2

![](images/image-1898.jpg)

接下来是 hash：

![](images/image-1899.jpg)
...
![](images/image-1900.jpg)

![](images/image-1901.jpg)

    hget hash1 key3

![](images/image-1902.jpg)
...
![](images/image-1907.jpg)

等到了过期时间就会自动删除：

![](images/image-1908.jpg)

想查剩余过期时间使用 ttl：

![](images/image-1909.jpg)
...
![](images/image-1910.jpg)

可以看到它确实把数据保存到了宿主机，这样就不怕再跑一个容器数据会丢了：

![](images/image-1911.jpg)

![](images/image-1912.jpg)
