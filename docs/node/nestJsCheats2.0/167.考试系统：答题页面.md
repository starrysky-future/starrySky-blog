...
![](images/image-5360.jpg)

打开链接就可以答题了：

![](images/image-5361.jpg)

答完点提交会立刻判卷，给出分数，还可以查看正确答案和解析：

![](images/image-5362.jpg)

这节我们来实现这部分功能。

首先给编辑按钮加上跳转编辑器的链接：

![image.png](images/image.png-5363.jpg)

![image.png](images/image.png-5364.jpg)
...
![2024-08-27 10.03.31.gif](images/2024-08-27 10.03.31.gif-5365.jpg)

跳转成功，id 也是对的。

我们编辑下，点击保存：

![2024-08-27 15.12.05.gif](images/2024-08-27 15.12.05.gif-5366.jpg)

加个返回按钮：

![image.png](images/image.png-5367.jpg)
...
![2024-08-27 15.15.13.gif](images/2024-08-27 15.15.13.gif-5368.jpg)

编辑完，点击保存，然后返回列表页就好了。

然后生成考试链接：

![image.png](images/image.png-5369.jpg)
...
![2024-08-27 15.20.05.gif](images/2024-08-27 15.20.05.gif-5370.jpg)
...
![image.png](images/image.png-5371.jpg)
...
![2024-08-27 15.33.21.gif](images/2024-08-27 15.33.21.gif-5373.jpg)
...
![image.png](images/image.png-5374.jpg)

加一个 state 来存储 answer 数组，拿到 json 的时候初始化 answers 数组。

然后表单 onChange 的时候修改 answers 数组元素。

![image.png](images/image.png-5375.jpg)
点击提交的时候，打印下：

![image.png](images/image.png-5376.jpg)
...
![2024-08-27 16.01.23.gif](images/2024-08-27 16.01.23.gif-5377.jpg)

接下来只要调用下新建答卷的接口就好了。

![image.png](images/image.png-5378.jpg)
...
测试下：
![2024-08-27 16.14.41.gif](images/2024-08-27 16.14.41.gif-5379.jpg)

提交成功，跳转的链接也是对的。

看下返回的响应：

![image.png](images/image.png-5380.jpg)
