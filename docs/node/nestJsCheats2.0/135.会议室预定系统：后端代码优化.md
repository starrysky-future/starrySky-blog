...
![](images/image-4433.jpg)

端口是 3005。

删掉 .dev.env 再跑试试：

![](images/image-4434.jpg)
...
![](images/image-4436.jpg)

注释掉 fe 的容器，并且给 nest 容器映射下 3005 端口：

![](images/image-4437.jpg)
...
注册：
![](images/image-4451.jpg)

修改密码：
![](images/image-4452.jpg)

登录：

![](images/image-4453.jpg)

修改个人信息：

![](images/image-4454.jpg)
...
![](images/image-4460.jpg)

现在一个验证码就只能用一次了。

只不过提示不大对，应该提示这个：

![](images/image-4461.jpg)

改一下 front_user 项目里 UpdateInfo 组件的 onFinish 的处理：

![](images/image-4462.jpg)

状态码非 20x 的时候展示返回的错误信息。

![](images/image-4463.jpg)

现在就对了。

front_admin 项目里的 InfoModify 组件也要做同样的修改：

![](images/image-4464.jpg)
