...
![](images/image-4248.jpg)

然后在 docker desktop 里搜索这个镜像，点击 run：

![](images/image-4249.jpg)

![](images/image-4250.jpg)
...
![](images/image-4251.jpg)

浏览器访问下：

![](images/image-4252.jpg)

界面正常渲染，访问接口的 url 也换成了 nginx 的：

![](images/image-4253.jpg)
...
![](images/image-4256.jpg)

把之前的 container 停止、删除，然后重新跑。

![](images/image-4257.jpg)

![](images/image-4258.jpg)

现在你就会发现所有的路由都能正常访问了：

![](images/image-4259.jpg)

![](images/image-4260.jpg)

当然，我们现在是单独跑的 nginx 的容器，而且反向代理 nest 服务时用的是 ip。

![](images/image-4261.jpg)
...
![](images/image-4262.jpg)

重新 build：

![](images/image-4263.jpg)

然后在 backend 项目的 docker-compose.yml 里配置下：

![](images/image-4264.jpg)
...
![](images/image-4266.jpg)

跑起来之后，浏览器访问下：

![](images/image-4267.jpg)

![](images/image-4268.jpg)

这样，我们就通过 docker compose 一次性跑了 nest、nginx 还有 mysql 和 redis 服务。

![](images/image-4269.jpg)
...
![](images/image-4270.jpg)

进入管理控制台：

![](images/image-4271.jpg)

点击创建镜像仓库。

![](images/image-4272.jpg)

它会让你先创建命名空间。

![](images/image-4273.jpg)

![](images/image-4274.jpg)

直接说明了如何登陆阿里云镜像仓库和 push 镜像上去：

![](images/image-4275.jpg)

我们在本地 build 下镜像。

复制下你买的服务器的公网 ip：

![](images/image-4276.jpg)

改一下项目里的 baseURL，改成服务器的 ip：

![](images/image-4277.jpg)
...
![](images/image-4284.jpg)

![](images/image-4285.jpg)

之后在安全组添加 80 端口：

![](images/image-4286.jpg)

但是这时你用 ip 访问，会发现没返回东西：

![](images/image-4287.jpg)

为什么呢？

往上翻一下日志，可能会有这个报错：

![](images/image-4288.jpg)
...
![](images/image-4291.jpg)

这时浏览器就可以看到页面正常渲染了：

![](images/image-4292.jpg)

如果你没遇到 platform 的问题，那直接就可以在浏览器看到结果。

请求的 url 也是对的：

![](images/image-4293.jpg)

![](images/image-4294.jpg)
