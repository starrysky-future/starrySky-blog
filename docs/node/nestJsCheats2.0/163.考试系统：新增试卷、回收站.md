...
![image.png](images/image.png-5281.jpg)

![image.png](images/image.png-5282.jpg)
...
![](images/image-5283.jpg)

没啥问题。

然后实现发布状态的修改：

![image.png](images/image.png-5284.jpg)

之前我们只实现了 publish 接口，没实现 unpublish 接口。

在后端代码加一下：

![image.png](images/image.png-5285.jpg)
...
![image.png](images/image.png-5286.jpg)
...
![image.png](images/image.png-5287.jpg)

![image.png](images/image.png-5288.jpg)
...
![image.png](images/image.png-5289.jpg)

![image.png](images/image.png-5290.jpg)
...
![2024-08-26 13.08.07.gif](images/2024-08-26 13.08.07.gif-5291.jpg)
...
![image.png](images/image.png-5292.jpg)

![image.png](images/image.png-5293.jpg)
...
![2024-08-26 13.13.16.gif](images/2024-08-26 13.13.16.gif-5294.jpg)

这时候其实已经删除了，只不过我们用的逻辑删除。

在列表过滤下：

![image.png](images/image.png-5295.jpg)
...
![2024-08-26 13.15.31.gif](images/2024-08-26 13.15.31.gif-5296.jpg)

然后支持下回收站的显示：

![image.png](images/image.png-5297.jpg)
...
![2024-08-26 13.20.59.gif](images/2024-08-26 13.20.59.gif-5298.jpg)

这样，回收站功能就完成了。

我们再给删除加个二次确认弹窗：

![image.png](images/image.png-5299.jpg)
...
![2024-08-26 13.23.32.gif](images/2024-08-26 13.23.32.gif-5300.jpg)

整体测试下：

创建两个考试：

![2024-08-26 13.24.19.gif](images/2024-08-26 13.24.19.gif-5301.jpg)

![2024-08-26 13.24.52.gif](images/2024-08-26 13.24.52.gif-5302.jpg)

删除其中一个，然后进回收站看一下：

![2024-08-26 13.25.29.gif](images/2024-08-26 13.25.29.gif-5303.jpg)

再试下发布功能：

![2024-08-26 13.26.01.gif](images/2024-08-26 13.26.01.gif-5304.jpg)
