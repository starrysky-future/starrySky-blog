...
![](images/image-4070.jpg)

![](images/image-4071.jpg)
...
![](images/image-4073.jpg)

我们在 entities 引入：

![](images/image-4074.jpg)

typeorm 会自动建表和创建外键：

![](images/image-4075.jpg)

在 mysql workbench 里可以看到这个表：

![](images/image-4076.jpg)

这两个外键都是 restrict 的约束：

![](images/image-4077.jpg)

restrict 是只有从表没有相关记录，才可以删除主表记录。

但我们会议室是支持删除的，怎么办呢？

![](images/image-4078.jpg)
...
![](images/image-4079.jpg)

在数据库的 booking 表可以看到插入了 4 条记录：

![](images/image-4080.jpg)
...
![](images/image-4081.jpg)

我们来写一下：

![](images/image-4082.jpg)
...
![](images/image-4083.jpg)

先看下有啥数据：

![](images/image-4084.jpg)

![](images/image-4085.jpg)

![](images/image-4086.jpg)
...
![](images/image-4088.jpg)

打印了一堆 sql，下面有查询的结果：

![](images/image-4089.jpg)

查询出来的是 id 为 1 和 3 的记录。

因为条件是 user.name 包含 guang：

![](images/image-4090.jpg)

room.name 包含天王：

![](images/image-4091.jpg)

所以查出这两条是对的：

![](images/image-4092.jpg)
...
![](images/image-4093.jpg)

可以在这里指定 select 的字段：

![](images/image-4094.jpg)

但这样有点麻烦。

我们直接查出来之后把它删掉就好了：

![](images/image-4095.jpg)
...
![](images/image-4099.jpg)

带在 Aothrization 的 header 上访问 add 接口：

![](images/image-4100.jpg)

![](images/image-4101.jpg)
...
![](images/image-4106.jpg)

状态有这 4 种：

![](images/image-4107.jpg)
...
![](images/image-4112.jpg)

第一次催办，管理员会收到邮件：

![](images/image-4113.jpg)

第二次催办，会提示半小时只能催办一次：

![](images/image-4114.jpg)

在 RedisInsight 里可以看到这两个 key：

![](images/image-4115.jpg)
