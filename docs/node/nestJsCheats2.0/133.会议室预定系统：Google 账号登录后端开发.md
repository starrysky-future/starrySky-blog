...
![](images/image-4366.jpg)

![](images/image-4367.jpg)
...
![](images/image-4369.jpg)

会跳到这个页面：

![](images/image-4370.jpg)

因为缺少了 username 的信息，你填上之后就可以注册了。

并且它还自动给你登录了：

![](images/image-4371.jpg)

然后退出登录用 google 账号登录一次：

![](images/image-4372.jpg)
...
![](images/image-4380.jpg)

当密码错误：

![](images/image-4381.jpg)

用户名密码都正确时：

![](images/image-4382.jpg)
...
![](images/image-4384.jpg)

![](images/image-4385.jpg)
...
![](images/image-4386.jpg)

之后在 UserController 添加两个路由：

![](images/image-4387.jpg)
...
![](images/image-4392.jpg)

生成的迁移类没问题：

![](images/image-4393.jpg)
...
![](images/image-4394.jpg)

在数据库看一下：

![](images/image-4395.jpg)

![](images/image-4396.jpg)

loginType 列添加成功了。

![](images/image-4397.jpg)
...
![](images/image-4409.jpg)

在 callback/google 里注入 Response，设置 cookie：

![](images/image-4410.jpg)

然后重定向：

![](images/image-4411.jpg)

试一下：

![](images/image-4412.jpg)

重定向没问题。

cookie 也没问题：

![](images/image-4413.jpg)

![](images/image-4414.jpg)

此外，我们还要处理下普通的登录，用户名密码登录的时候要过滤下 loginType：

![](images/image-4415.jpg)
