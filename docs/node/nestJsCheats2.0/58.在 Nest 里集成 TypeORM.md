...
![](images/image-1676.jpg)

生成的 service 里的 crud 并没有真正实现：

![](images/image-1677.jpg)
...
![](images/image-1679.jpg)

这部分和我们单独跑 typeorm 没啥区别：

![](images/image-1680.jpg)

然后是增删改查，我们可以注入 EntityManager：

![](images/image-1681.jpg)
...
![](images/image-1682.jpg)

服务端打印了 insert 的 sql 语句：

![](images/image-1683.jpg)

表里也可以看到这条数据了：

![](images/image-1684.jpg)

对应的是这个 handler：

![](images/image-1685.jpg)

然后再试下查询：

![](images/image-1686.jpg)

![](images/image-1687.jpg)

![](images/image-1688.jpg)

单个查询和全部查询都是可以的。

再就是修改：

![](images/image-1689.jpg)

在 controller 里是接受 patch 的请求。

在 postman 里发一下：
![](images/image-1690.jpg)

可以看到生成了 update 的 sql 语句：

![](images/image-1691.jpg)

数据库中的数据也被修改了：

![](images/image-1692.jpg)

再试试删除：

![](images/image-1693.jpg)

在 postman 里发送 delete 的请求：

![](images/image-1694.jpg)

可以看到生成了 delete 的 sql 语句：

![](images/image-1695.jpg)

数据库里的数据确实被删除了：

![](images/image-1696.jpg)
...
![](images/image-1702.jpg)

它会引入 TypeOrmCoreModule.forRoot 的动态模块：

![](images/image-1703.jpg)
