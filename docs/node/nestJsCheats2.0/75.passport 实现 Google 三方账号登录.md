...
![](images/image-2265.jpg)

填入项目名后点击 create：

![](images/image-2266.jpg)

点击左上角的按钮切换到你刚刚创建的 project：

![](images/image-2267.jpg)

进入 api & service 页面：

![](images/image-2268.jpg)

点击 OAuth consent screen，然后勾选 external，点击 create：

![](images/image-2269.jpg)

输入三个必填信息：

![](images/image-2270.jpg)

![](images/image-2271.jpg)

点击 save and continue。

然后点击 Credentials 创建凭证：

![](images/image-2272.jpg)

输入应用类型、name、填入授权的域名、回调的 url，点击 create：

![](images/image-2273.jpg)

这样 client id 和 client secret 就生成好了：

![](images/image-2274.jpg)
...
![](images/image-2283.jpg)

![](images/image-2284.jpg)
...
![](images/image-2286.jpg)

这部分和我们单独跑 typeorm 没啥区别：

![](images/image-2287.jpg)

然后是增删改查，我们可以注入 EntityManager：

![](images/image-2288.jpg)

自动创建了对应的表。

在 mysql workbench 里也可以看到：

![](images/image-2289.jpg)
