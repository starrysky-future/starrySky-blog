...
![](images/image-795.jpg)

浏览器访问下：

![](images/image-796.jpg)
...
![](images/image-799.jpg)

![](images/image-800.jpg)
...
![](images/image-802.jpg)

![](images/image-803.jpg)

校验生效了。

现在接收到的参数是普通对象：

![](images/image-804.jpg)

在 ValidationPipe 指定 transform: true 之后，就会转为 dto 的实例了：

![](images/image-805.jpg)
...
![](images/image-810.jpg)

![](images/image-811.jpg)

注册成功，创建了 users.json 文件，并写入了数据。

再注册一个：

![](images/image-812.jpg)

![](images/image-813.jpg)

也没问题。

再次注册同样的 username 会返回 400

![](images/image-814.jpg)

注册完成了，然后再实现下登录：

![](images/image-815.jpg)
...
当不满足校验规则时：
![](images/image-817.jpg)

当用户不存在时：

![](images/image-818.jpg)

当密码不正确时：

![](images/image-819.jpg)

登录成功时：

![](images/image-820.jpg)
