...
![](images/image-845.jpg)

![](images/image-846.jpg)
...
![](images/image-848.jpg)

浏览器访问下：

![](images/image-849.jpg)
...
![](images/image-850.jpg)

都没问题。

然后在 src 下创建 3 个组件：Login、Register、BookManage，把其余无用文件去掉：

![](images/image-851.jpg)

![](images/image-852.jpg)
...
![](images/image-855.jpg)

输入用户名、密码、确认密码，点击注册：

![](images/image-856.jpg)
...
![](images/image-857.jpg)

提示跨域。

在后端项目支持下跨域访问：

![](images/image-858.jpg)

再试下：

![](images/image-859.jpg)
...
![](images/image-860.jpg)

没啥问题。

然后在 interfaces/index.ts 里添加 login 接口：

![](images/image-861.jpg)
