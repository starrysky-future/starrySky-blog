...
![](images/image-4675.jpg)

浏览器访问下：

![](images/image-4676.jpg)

nest 服务跑起来了。

按照上节的步骤把 etcd 服务跑起来：

![](images/image-4677.jpg)

然后我们加一个 etcd 的 provider：

![](images/image-4678.jpg)
...
![](images/image-4680.jpg)

![](images/image-4681.jpg)

![](images/image-4682.jpg)

![](images/image-4683.jpg)
...
![](images/image-4685.jpg)

引入 EtcdModule：

![](images/image-4686.jpg)

然后在 AaaController 注入 EtcdService，添加两个 handler：

![](images/image-4687.jpg)
...
![](images/image-4688.jpg)

![](images/image-4689.jpg)
...
![](images/image-4690.jpg)

用起来是一样的：

![](images/image-4691.jpg)

但是现在 etcd 的参数是动态传入的了，这就是动态模块的好处。

当然，一般动态模块都有 forRootAsync，我们也加一下：

![](images/image-4692.jpg)

![](images/image-4693.jpg)
