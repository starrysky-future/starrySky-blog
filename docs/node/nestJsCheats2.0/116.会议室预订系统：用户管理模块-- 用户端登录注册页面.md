...
![](images/image-3698.jpg)

![](images/image-3699.jpg)

![](images/image-3700.jpg)

![](images/image-3701.jpg)
...
![](images/image-3706.jpg)

![](images/image-3707.jpg)

![](images/image-3708.jpg)

![](images/image-3709.jpg)

![](images/image-3710.jpg)
...
![](images/image-3714.jpg)

输入用户名、密码，点击登录：

![](images/image-3715.jpg)
...
![](images/image-3717.jpg)

在 postman 里测试下登录接口：

![](images/image-3718.jpg)
...
![](images/image-3719.jpg)

提示跨域错误：

![](images/image-3720.jpg)

我们在服务端开启下跨域支持：

![](images/image-3721.jpg)

再试下：

![](images/image-3722.jpg)

因为这个时候接口返回 400

![](images/image-3723.jpg)

![](images/image-3724.jpg)
...
![](images/image-3727.jpg)

提示登录成功，并且返回了用户信息和 token。

再输入错误的用户名、密码试试：

![](images/image-3728.jpg)

![](images/image-3729.jpg)
...
![](images/image-3730.jpg)

登录成功之后，在 Application > Local Storage 里就可以看到这三个值

![](images/image-3731.jpg)

用户不存在或者密码错误的时候，也提示了对应的错误：

![](images/image-3732.jpg)

![](images/image-3733.jpg)
...
![](images/image-3735.jpg)

填入信息，点击注册，控制台会打印表单值：

![](images/image-3736.jpg)

然后来调用下注册接口和发送验证码的接口。

在 swagger 文档看下这俩接口：

![](images/image-3737.jpg)

![](images/image-3738.jpg)

同样，我们先在 postman 里调用下：

调用发送验证码接口：

![](images/image-3739.jpg)

邮箱收到了对应的邮件：

![](images/image-3740.jpg)

然后调用注册接口：

![](images/image-3741.jpg)

注册成功，数据库也多了一条记录：

![](images/image-3742.jpg)
...
![](images/image-3743.jpg)

绑定点击事件。

![](images/image-3744.jpg)
...
![](images/image-3745.jpg)

![](images/image-3746.jpg)
...
![](images/image-3747.jpg)

去邮箱里看一下验证码：

![](images/image-3748.jpg)

填入验证码，点击注册：

![](images/image-3749.jpg)

注册成功，数据库里也看到了这条记录：

![](images/image-3750.jpg)

这样，注册的前后端流程就走完了。

然后我们给它加上跳转逻辑：

![](images/image-3751.jpg)
...
![](images/image-3752.jpg)

登录也要加上导航，登录成功后导航到首页：

![](images/image-3753.jpg)
...
![](images/image-3754.jpg)

![](images/image-3755.jpg)

测试下：

![](images/image-3756.jpg)

最后，我们再来重构下代码：

![](images/image-3757.jpg)

现在的代码都是平级放的，我们分几个目录：

![](images/image-3758.jpg)
