...
![](images/image-2960.jpg)

浏览器访问下：

![](images/image-2961.jpg)

![](images/image-2962.jpg)
...
![](images/image-2966.jpg)

因为我们本地访问用 localhost 是拿不到真实 ip 的。

你可以查一下本地 ip，用 ip 访问：

![](images/image-2967.jpg)

![](images/image-2968.jpg)

这里的 ::ffff 是 ipv6 地址的意思：

![](images/image-2969.jpg)

这样部署到线上之后就能拿到真实地址了。

那如果想拿到 ip 地址对应的城市呢？

![](images/image-2970.jpg)
...
![](images/image-2972.jpg)

然后在 interceptor 里注入 HttpService 来发请求：

![](images/image-2973.jpg)
...
![](images/image-2979.jpg)

当然，这个不建议放到请求日志里，不然每次请求都调用一次接口太浪费性能了。

登录日志里可以加这个。

![](images/image-2980.jpg)
