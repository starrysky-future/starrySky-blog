...
![](images/image-2503.jpg)

传入类型参数之后，返回的就是该类型了：

![](images/image-2504.jpg)
...
![](images/image-2505.jpg)

我们自己实现的 session 就生效了：

![](images/image-2506.jpg)

在 Redis Insight 里可以看到 session 的值

![](images/image-2507.jpg)

而且这个 session 是支持分布式的。

![](images/image-2508.jpg)
