...
![](images/image-5480.jpg)

全新的协议？那具体是什么样的协议呢？

这样的：

![](images/image-5481.jpg)

大家习惯的 http 协议是 key:value 的 header 带个 body 的：

![](images/image-5482.jpg)
...
![](images/image-5487.jpg)

这 3 个 header 还有 101 状态码都是我们返回的。

message 里也可以看到发送的消息：

![](images/image-5488.jpg)

再去服务端看看，也收到了这个消息：

![](images/image-5489.jpg)
...
![](images/image-5490.jpg)

我们需要第一个字节的后四位，也就是 opcode。

这样写：

![](images/image-5491.jpg)
...
![](images/image-5492.jpg)

第一位是 mask 标志位，后 7 位是 payload 长度。

可以这样取：

![](images/image-5493.jpg)
...
![](images/image-5500.jpg)

而现在我们能正确解析出其中的数据：

![](images/image-5501.jpg)

至此，我们 websocket 协议的解析成功了！

这样的协议格式的数据叫做 frame，也就是帧：

![](images/image-5502.jpg)
...
![](images/image-5506.jpg)

收到客户端消息后，每两秒回一个消息。

![](images/image-5507.jpg)
