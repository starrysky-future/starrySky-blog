...
![](images/image-1549.jpg)

而创建表的依据就是 Entity：

![](images/image-1550.jpg)
...
![](images/image-1552.jpg)

然后在 DataSource 的 entities 里引入下：

![](images/image-1553.jpg)

重新跑 npm run start。

生成建表 sql 是这样的：

![](images/image-1554.jpg)

格式化一下：

![](images/image-1555.jpg)

对比着 Entity 看下：

![](images/image-1556.jpg)

是不是就明白怎么映射了？

在 mysql workbench 里看下，确实生成了这个表：

![](images/image-1557.jpg)
...
![](images/image-1558.jpg)

![](images/image-1559.jpg)

可以看到数据库插入了这条记录：

![](images/image-1560.jpg)
...
![](images/image-1564.jpg)

可以看到确实生成了 3 条 insert into 的 sql 语句。

数据库中也能看到：

![](images/image-1565.jpg)
...
![](images/image-1566.jpg)

在 workbench 里也可以看到数据被修改了：

![](images/image-1567.jpg)
...
![](images/image-1568.jpg)

数据库了对应记录就被删除了：

![](images/image-1569.jpg)
