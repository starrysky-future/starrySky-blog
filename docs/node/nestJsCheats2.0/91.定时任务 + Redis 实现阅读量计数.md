...
![](images/image-2828.jpg)

刷新可以看到这个 database

![](images/image-2829.jpg)
...
![](images/image-2834.jpg)

可以看到 4 条 insert 语句：

![](images/image-2835.jpg)

在 mysql workbench 里也可以看到两个表都插入了数据：

![](images/image-2836.jpg)

![](images/image-2837.jpg)
...
![](images/image-2839.jpg)

![](images/image-2840.jpg)
...
![](images/image-2841.jpg)

当密码错误时：

![](images/image-2842.jpg)

登录成功时：

![](images/image-2843.jpg)
...
![](images/image-2845.jpg)

数据库里阅读量确实更新了：

![](images/image-2846.jpg)

再次查询出来的就是新的阅读量：

![](images/image-2847.jpg)
...
![](images/image-2849.jpg)

服务端打印了 3 条 sql：

![](images/image-2850.jpg)

redis 里也有了这个 hash 的结构：

![](images/image-2851.jpg)
...
![](images/image-2853.jpg)

重新跑一下：

![](images/image-2854.jpg)

现在就只有一条 select、一条 update 了。

![](images/image-2855.jpg)

然后多刷新几次：

![](images/image-2856.jpg)

没发送 sql，还是之前那两条：

![](images/image-2857.jpg)

因为这时候查的是 redis。

redis 里数据更新了：

![](images/image-2858.jpg)

但是数据库里的 viewCount 还是 8

![](images/image-2859.jpg)
...
![](images/image-2865.jpg)

现在只有一个 key，我们再访问下另一篇文章

![](images/image-2866.jpg)

现在就有 2 个 key 了：

![](images/image-2867.jpg)
...
![](images/image-2868.jpg)

刷新几次 view 接口，redis 里阅读量增加了：

![](images/image-2869.jpg)

但是数据库里没变：

![](images/image-2870.jpg)

过了一会，控制台打印了 2 条 update 语句：

![](images/image-2871.jpg)

数据库里的数据就更新了：

![](images/image-2872.jpg)

接下来只要把定时任务的执行时间改为 4 点就好了：

![](images/image-2873.jpg)
...
![](images/image-2875.jpg)

可以看到，现在就不是每次刷新都增加阅读量了，而是 3s 之后再刷新才增加。

在 redis 里可以看到这个 key：

![](images/image-2876.jpg)

只不过现在没登录，用的是 ip，而本地访问的时候获取的 ip 就是 ::1 这样的，线上就能拿到具体的 ip 了。

然后我们登录下再访问：

![](images/image-2877.jpg)

![](images/image-2878.jpg)

这时用的就是用户 id 了：

![](images/image-2879.jpg)
