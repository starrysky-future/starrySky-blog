...
![](images/image-4467.jpg)、

两个 transport 都生效了。

页面刷新下：

![](images/image-4468.jpg)

![](images/image-4469.jpg)
...
![](images/image-4470.jpg)

试下效果：

![](images/image-4471.jpg)
...
![](images/image-4473.jpg)

多刷新几次页面：

![](images/image-4474.jpg)

![](images/image-4475.jpg)
...
![](images/image-4476.jpg)

然后刷新页面，可以看到，日志被记录在了新的文件里：

![](images/image-4477.jpg)
...
![](images/image-4482.jpg)

改下端口：

![](images/image-4483.jpg)

加个 /log 的路由：

![](images/image-4484.jpg)
...
![](images/image-4485.jpg)

页面上触发下查询：

![](images/image-4486.jpg)

可以看到所有的日志都接收到了：

![](images/image-4487.jpg)

同时在 console、file、日志服务三个地方保存了日志，这就是 winston 的魅力。

![](images/image-4488.jpg)
