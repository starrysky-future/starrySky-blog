...
![](images/image-4327.jpg)

图片是保存在服务器 uploads 目录下的：

![](images/image-4328.jpg)

然后把这个目录设置为静态文件目录：

![](images/image-4329.jpg)

这样图片就能直接访问了：

![](images/image-4330.jpg)

数据库里保存的也是这个路径：

![](images/image-4331.jpg)
...
![](images/image-4333.jpg)

跑起来之后，访问下 http://localhost:9001

输入用户名密码后点击登录：

![](images/image-4334.jpg)

创建个 bucket：

![](images/image-4335.jpg)

设置下可以公开访问：

![](images/image-4336.jpg)

![](images/image-4337.jpg)

然后上传个文件：

![](images/image-4338.jpg)

![](images/image-4339.jpg)

复制路径，然后浏览器访问下：

http://localhost:9000/meeting-room-booking-system/headpic1.jpg

![](images/image-4340.jpg)
...
![](images/image-4343.jpg)

![](images/image-4344.jpg)

这些当然也可以放到配置文件里配置：

![](images/image-4345.jpg)

![](images/image-4346.jpg)
...
![](images/image-4347.jpg)

所以可以直接在 MinioModule 里注入 ConfigService：

![](images/image-4348.jpg)
...
![](images/image-4355.jpg)

提示上传成功。

在 minio 管理界面也可以看到这个文件：

![](images/image-4356.jpg)

接下来只要改下 onChange 的值，以及回显的图片的 url 就好了。

![](images/image-4357.jpg)
...
![](images/image-4358.jpg)

输入验证码，点击修改，会提示更新成功：

![](images/image-4359.jpg)

去数据库里看下：

![](images/image-4360.jpg)
