...
![](images/image-1928.jpg)

![](images/image-1929.jpg)
...
![](images/image-1930.jpg)

之后在 AppController 加几个路由：

![](images/image-1931.jpg)
...
![](images/image-1932.jpg)

然后 set 设置为 111：

![](images/image-1933.jpg)

再次 get 就有数据了：

![](images/image-1934.jpg)

之后 del 删掉：

![](images/image-1935.jpg)

再次 get 就为空了：

![](images/image-1936.jpg)

这个缓存的用法很简单。

此外，你还可以把它加到 handler 上，自动对结果缓存。

![](images/image-1937.jpg)
...
![](images/image-1938.jpg)

![](images/image-1939.jpg)

改变参数再刷新几次：

![](images/image-1940.jpg)

![](images/image-1941.jpg)
...
![](images/image-1943.jpg)

![](images/image-1944.jpg)

![](images/image-1945.jpg)

这时候在 redis 里就可以看到缓存的数据：

![](images/image-1946.jpg)

注意，连接的时候我们指定 database 为 2，所以在 RedisInsight 里要切到 db2 才可以看到这些数据。

缓存的过期时间也是可以配置的：

![](images/image-1947.jpg)

![](images/image-1948.jpg)

![](images/image-1949.jpg)
...
![](images/image-1950.jpg)

![](images/image-1951.jpg)

![](images/image-1952.jpg)

而用 CacheManager 的话，只支持 get、set：

![](images/image-1953.jpg)
...
![](images/image-1957.jpg)

跑一下：

![](images/image-1958.jpg)

![](images/image-1959.jpg)

![](images/image-1960.jpg)
