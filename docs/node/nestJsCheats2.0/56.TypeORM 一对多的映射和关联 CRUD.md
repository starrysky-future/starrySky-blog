...
![](images/image-1626.jpg)

因为 index.ts 里用到了 User，我们用不到，把这些代码删掉：

![](images/image-1627.jpg)

然后 npm run start：

![](images/image-1628.jpg)
...
![](images/image-1629.jpg)

在多的一方使用 @ManyToOne 装饰器。

把这两个表删掉：

![](images/image-1630.jpg)

重新 npm run start：

![](images/image-1631.jpg)

就可以看到创建了两个表，并且在 employee 表添加了外建约束。

workbench 里也可以看到这个外键：

![](images/image-1632.jpg)
