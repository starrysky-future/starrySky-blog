...
![](images/image-2086.jpg)

直接给用户分配权限。

而 RBAC 是这样的：

![](images/image-2087.jpg)
...
![](images/image-2088.jpg)

可以看到创建出的 database：

![](images/image-2089.jpg)
...
![](images/image-2091.jpg)

添加 User、Role、Permission 的 Entity：

![](images/image-2092.jpg)
...
![](images/image-2095.jpg)

![](images/image-2096.jpg)

![](images/image-2097.jpg)

![](images/image-2098.jpg)

![](images/image-2099.jpg)

还有外键：

![](images/image-2100.jpg)

![](images/image-2101.jpg)
...
![](images/image-2103.jpg)

服务端控制台打印了一堆 sql：

![](images/image-2104.jpg)
...
![](images/image-2105.jpg)

role 表：

![](images/image-2106.jpg)

user 表：

![](images/image-2107.jpg)

role_permission_relation 中间表：

![](images/image-2108.jpg)

user_role_relation 中间表：

![](images/image-2109.jpg)
...
![](images/image-2110.jpg)

然后在 postman 里测试下：

ValidationPipe 不通过的时候，会返回错误信息：

![](images/image-2111.jpg)

ValidationPipe 通过之后，就会执行 handler 里的方法：

![](images/image-2112.jpg)

![](images/image-2113.jpg)
...
![](images/image-2114.jpg)

![](images/image-2115.jpg)
...
![](images/image-2119.jpg)

![](images/image-2120.jpg)

现在这些接口可以直接访问：

![](images/image-2121.jpg)

![](images/image-2122.jpg)
...
![](images/image-2123.jpg)

但这时候会报错 user 不在 Request 的类型上。

扩展下就好了：

![](images/image-2124.jpg)
...
![](images/image-2125.jpg)

这样太麻烦了，这次我们全局加：

![](images/image-2126.jpg)
...
![](images/image-2127.jpg)

再访问下 aaa、bbb 接口：

![](images/image-2128.jpg)

![](images/image-2129.jpg)

但这时候你访问 /user/login 接口也被拦截了：

![](images/image-2130.jpg)
...
![](images/image-2134.jpg)

因为没有 require-login 的 metadata：

![](images/image-2135.jpg)

而 aaa、bbb 是需要登录的：

![](images/image-2136.jpg)

![](images/image-2137.jpg)

因为它们包含 require-login 的 metadata：

![](images/image-2138.jpg)

然后我们登录下，带上 token 访问试试：

![](images/image-2139.jpg)

![](images/image-2140.jpg)
...
![](images/image-2143.jpg)

可以看到打印了这个用户拥有的角色的所有 permission 信息：

![](images/image-2144.jpg)

再增加个自定义 decorator：

![](images/image-2145.jpg)
...
![](images/image-2146.jpg)

在 PermissionGuard 里取出来判断：

![](images/image-2147.jpg)
...
![](images/image-2148.jpg)

带上 token 访问：

![](images/image-2149.jpg)
...
![](images/image-2151.jpg)

我们再登录下张三账号：

![](images/image-2152.jpg)

用这个 token 去访问下 bbb 接口，就能正常访问了：

![](images/image-2153.jpg)

他是有这个权限的：

![](images/image-2154.jpg)
