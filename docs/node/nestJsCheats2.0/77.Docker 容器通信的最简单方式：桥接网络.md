...
![image.png](images/image.png-2336.jpg)
...
![](images/image-2337.jpg)

然后 nest 的部分我们要改下代码：

修改 AppModule 的代码，改成用容器名来访问：

![](images/image-2338.jpg)
...
![](images/image-2341.jpg)

浏览器访问 http://localhost:3000

![](images/image-2342.jpg)
...
![](images/image-2344.jpg)

现在可以通过容器名直接互相访问了：

![](images/image-2345.jpg)

原理前面讲过，就是 Namespace。

本来是 3 个独立的 Network Namespace：

![](images/image-2346.jpg)

桥接之后就这样了：

![](images/image-2347.jpg)
...
![](images/image-2351.jpg)

可以看到，会先 build dockerfile 产生镜像，然后把 3 个镜像跑起来。

![](images/image-2352.jpg)
...
![](images/image-2353.jpg)

也拿到了 redis 的 key，说明 redis 服务跑成功了：

![](images/image-2354.jpg)
...
![](images/image-2355.jpg)

把 networks 部分注释掉，重新跑：

![](images/image-2356.jpg)

你会发现它创建了一个默认的 network：

![](images/image-2357.jpg)

mysql 和 redis 的访问都是正常的：

![](images/image-2358.jpg)
