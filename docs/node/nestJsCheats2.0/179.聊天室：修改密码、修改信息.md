...
![](images/image-5624.jpg)

对应这两个页面：

![](images/image-5625.jpg)
...
![](images/image-5627.jpg)

登录，拿到 token。

然后带上 token 访问 /user/info

![](images/image-5628.jpg)
...
![](images/image-5629.jpg)

![](images/image-5630.jpg)
...
![](images/image-5631.jpg)

在 redis 里手动添加 update*password_captcha*邮箱 的 key，值为 111111

![](images/image-5632.jpg)

半小时过期。

注意，我们现在连的是 db2

![](images/image-5633.jpg)

然后再试下：

![](images/image-5634.jpg)

修改成功。

我们为了开发方便没对密码做加密，可以直观看出来密码修改成功了：

![](images/image-5635.jpg)
...
![](images/image-5636.jpg)

![](images/image-5637.jpg)
...
![](images/image-5639.jpg)

![](images/image-5640.jpg)

登录账号拿到 token：

![](images/image-5641.jpg)

带上 token 访问 /user/update 接口：

![](images/image-5642.jpg)

更改成功。

查询下：

![](images/image-5643.jpg)
