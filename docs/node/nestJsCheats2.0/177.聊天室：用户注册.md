...
![](images/image-5561.jpg)

在 docker desktop 里把 mysql 的容器跑起来：

![](images/image-5562.jpg)
...
![](images/image-5563.jpg)

![](images/image-5564.jpg)
...
![](images/image-5565.jpg)

![](images/image-5566.jpg)
...
![](images/image-5571.jpg)

```
nest g service prisma --no-spec
```

![](images/image-5572.jpg)
...
![](images/image-5574.jpg)

在 UserService 里注入 PrismaService 来做 crud：

![](images/image-5575.jpg)
...
![](images/image-5578.jpg)

在 postman 里调用下试试：

![](images/image-5579.jpg)
...
![](images/image-5580.jpg)

数据库中没有 captcha 的字段。

我们要在调用 service 之前删掉它：

![](images/image-5581.jpg)

再试一下：

![](images/image-5582.jpg)

服务端打印了 insert 的 sql 语句：

![](images/image-5583.jpg)

数据库里也可以看到这条记录：

![](images/image-5584.jpg)
...
![](images/image-5591.jpg)

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](images/image-5592.jpg)

![](images/image-5593.jpg)

测试下：

带上错误的验证码，返回验证码不正确；

![](images/image-5594.jpg)
带上正确的验证码，注册成功：

![](images/image-5595.jpg)
这时可以在数据库里看到这条记录：

![](images/image-5596.jpg)
...
![](images/image-5599.jpg)

邮件发送成功：

![](images/image-5600.jpg)

redis 里也保存了邮箱地址对应的验证码：

![](images/image-5601.jpg)

通过邮件发送验证码之后，保存到 redis，注册的时候取出邮箱地址对应的验证码来校验。

这样，整个注册的流程就完成了。

![](images/image-5602.jpg)
