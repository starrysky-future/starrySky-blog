...
![](images/image-4884.jpg)

生成了 .env 和 schema 文件：

![](images/image-4885.jpg)

然后改下 .env 文件的数据库连接信息：

![](images/image-4886.jpg)
...
![](images/image-4890.jpg)

可以看到，生成了 client 代码、docs 文档，还有 sql 文件。

数据库中也多了这个表：

![](images/image-4891.jpg)
...
![](images/image-4892.jpg)

打印了插入数据的 sql。

去 mysql workbench 里看下：

![](images/image-4893.jpg)
...
![](images/image-4897.jpg)

但是如果指定 name 就不行了：

![](images/image-4898.jpg)
...
![](images/image-4905.jpg)

此外，where 条件这里可以指定的更细致：

![](images/image-4906.jpg)
...
![](images/image-4907.jpg)

createMany 我们用过，这里就不测了：

![](images/image-4908.jpg)
...
![](images/image-4911.jpg)

在 mysql workbench 里可以看到，确实改了：

![](images/image-4912.jpg)
...
![](images/image-4913.jpg)

![](images/image-4914.jpg)

第二次跑就是 update 了：

![](images/image-4915.jpg)

![](images/image-4916.jpg)
...
![](images/image-4917.jpg)

可以看到有两条 delete 语句。

![](images/image-4918.jpg)
...
![](images/image-4922.jpg)

对应的 sql 如下：

![](images/image-4923.jpg)
...
![](images/image-4924.jpg)

在 mysql workbench 里刷新下，可以看到确实改了：

![](images/image-4925.jpg)
...
结果如下：
![](images/image-4927.jpg)

因为 age 大于 2 的就 2 条，然后算平均值、计数，就是上面的结果了：

![](images/image-4928.jpg)
