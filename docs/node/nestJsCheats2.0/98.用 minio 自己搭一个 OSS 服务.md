...
![](images/image-3057.jpg)

我们创建个 Bucket：

![](images/image-3058.jpg)

然后进入文件列表，就可以上传文件了：

![](images/image-3059.jpg)

因为创建的 Bucket 设置了公共读，所以可以直接访问：

![](images/image-3060.jpg)
...
![](images/image-3062.jpg)

acessKey 是在这里看：

![](images/image-3063.jpg)

具体创建 accessKey 的流程看[之前 OSS 那节](https://juejin.cn/book/7226988578700525605/section/7324620995183968293)

然后跑一下：

![](images/image-3064.jpg)

上传成功之后就可以通过 OSS 服务访问这个图片了：

![](images/image-3065.jpg)

也可以通过 sdk 下载图片：

![](images/image-3066.jpg)

执行后可以看到，图片被下载下来了：

![](images/image-3067.jpg)
...
![](images/image-3068.jpg)

打开后可以看到本地的所有镜像和容器：

![](images/image-3069.jpg)

搜索下 minio（这步需要科学上网）：

![](images/image-3070.jpg)

填入一些信息：

![](images/image-3071.jpg)
...
![](images/image-3072.jpg)

访问下 http://localhost:9001

输入刚才环境变量填的用户名密码：

![](images/image-3073.jpg)

进入管理界面：

![](images/image-3074.jpg)
...
![](images/image-3075.jpg)

然后在这个 bucket 下上传一个文件：

![](images/image-3076.jpg)

![](images/image-3077.jpg)

点击 share 就可以看到这个文件的 url：

![](images/image-3078.jpg)

![](images/image-3079.jpg)

现在倒是能在浏览器访问，只不过需要带后面的一长串东西：

![](images/image-3080.jpg)

不带的话会提示拒绝访问：

![image.png](images/image.png-3081.jpg)

因为现在文件访问权限不是公开的。

我们设置下：

![](images/image-3082.jpg)

![](images/image-3083.jpg)

添加一个 / 的匿名的访问规则。

然后就可以直接访问了：

![](images/image-3084.jpg)
...
创建用到的 accessKey：
![](images/image-3085.jpg)

![](images/image-3086.jpg)

跑一下：

![](images/image-3087.jpg)

可以看到，文件上传成功了：

![](images/image-3088.jpg)

![](images/image-3089.jpg)

同样，也可以下载文件：

![](images/image-3090.jpg)
