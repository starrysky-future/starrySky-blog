...
![](images/image-6063.jpg)

但这时候你再用 show dbs 会发现没有这个 db：

![](images/image-6064.jpg)
...
![](images/image-6066.jpg)

创建和删除 database 我们会了，然后是 collection：

![](images/image-6067.jpg)
...
![](images/image-6069.jpg)

![](images/image-6070.jpg)
...
![](images/image-6085.jpg)

连接上 mongodb 的 server：

![](images/image-6086.jpg)

在 GUI 工具里操作就很方便直观了：

![](images/image-6087.jpg)

可以看到所有的 database、collection、document。

在这里输入过滤条件后点击 find：

![](images/image-6088.jpg)

更新和删除也都很直观：

![](images/image-6089.jpg)

![](images/image-6090.jpg)

![](images/image-6091.jpg)
