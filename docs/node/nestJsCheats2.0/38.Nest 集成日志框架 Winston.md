...
![](images/image-1058.jpg)

现在的 logger 就换成我们自己的了。

然后在 AppController 里添加 logger：

![](images/image-1059.jpg)

浏览器访问下：

![](images/image-1060.jpg)

![](images/image-1061.jpg)
...
![](images/image-1063.jpg)

是不是和 nest 原本的日志很像了？

然后我们再加一个 File 的 transport。

![](images/image-1064.jpg)
...
![](images/image-1065.jpg)

file 的日志是这样的：

![](images/image-1066.jpg)

这样，我们就完成了 nest 和 winston 的集成。

我们还可以进一步把它封装成一个动态模块。

![](images/image-1067.jpg)
...
![](images/image-1071.jpg)

只不过现在就没必要每次都 new 了：

![](images/image-1072.jpg)
