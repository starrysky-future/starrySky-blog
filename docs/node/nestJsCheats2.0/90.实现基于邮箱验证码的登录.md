...
![](images/image-2769.jpg)

![](images/image-2770.jpg)
...
![](images/image-2771.jpg)

比较丑，但功能是没问题的：

![](images/image-2772.jpg)
...
![](images/image-2773.jpg)

在 main.ts 启用跨域，并且修改下端口号（因为前端项目开发服务也用这个端口号）：

![](images/image-2774.jpg)
...
![](images/image-2780.jpg)

保存，nest 服务会自动重新跑：

![](images/image-2781.jpg)

可以看到 user 表被创建了。

![](images/image-2782.jpg)

这次我们手动插入下数据：

![](images/image-2783.jpg)

输入内容后，点击 apply，可以看到生成的 sql：

![](images/image-2784.jpg)
...
![](images/image-2785.jpg)

![](images/image-2786.jpg)
...
![](images/image-2787.jpg)

发送成功，邮箱里确实也收到了这封邮件：

![](images/image-2788.jpg)

![](images/image-2789.jpg)

回过头来看一下，我们现在是把邮箱相关信息直接写在代码里了。

![](images/image-2790.jpg)
...
![](images/image-2792.jpg)

然后在 EmailService 里注入 ConfigService，从中读取配置：

![](images/image-2793.jpg)
...
![](images/image-2794.jpg)

![](images/image-2795.jpg)

说明配置正确读取出来了。

不过用了 .env 配置文件之后有个问题：

![](images/image-2796.jpg)
...
![](images/image-2802.jpg)

```javascript
const code = Math.random().toString().slice(2, 8);
```

![](images/image-2803.jpg)

然后在前端项目里调用下看看：

![](images/image-2804.jpg)

通过 useForm 创建 form 实例，然后就可以通过 form.getFieldsValue 拿到表单值了：

![](images/image-2805.jpg)
...
![](images/image-2812.jpg)

输入邮箱地址，点击发送验证码。

邮箱收到了这个验证码：

![](images/image-2813.jpg)

redis 里也保存了一份：

![](images/image-2814.jpg)

接下来只要填入这个验证码，点击登录就可以了：

![](images/image-2815.jpg)
...
![](images/image-2818.jpg)

![](images/image-2819.jpg)
...
![](images/image-2820.jpg)

输入邮箱，点击发送验证码。

![](images/image-2821.jpg)

收到了验证码邮件，并且 redis 里也存了这个 key：

![](images/image-2822.jpg)

带上这个验证码请求：

![](images/image-2823.jpg)

可以看到服务端通过了校验，并且从数据库中查询出了用户信息：

![](images/image-2824.jpg)
