...
![](images/image-5644.jpg)

聊天室有专门的表，加入群聊就是往用户-聊天室的中间表插入一条记录：

![](images/image-5645.jpg)

我们先来实现好友关系的保存：

![](images/image-5646.jpg)
...
![](images/image-5647.jpg)

可以看到，生成的 sql 是对的：

![](images/image-5648.jpg)

一个中间表，两个字段 userId、friendId 都是外键，引用 user 表的 id。

现在好友关系表里还没有数据：

![](images/image-5649.jpg)

我们先注册几个用户：

![](images/image-5650.jpg)

自己注册的时候可以先把验证码这段注释掉：

![](images/image-5651.jpg)

然后手动在 friendship 表里加入几条好友关系：

![](images/image-5652.jpg)
...
![](images/image-5653.jpg)

这就是好友列表的功能：

![](images/image-5654.jpg)

而添加和删除好友就是在这个好友关系表里新增、删除数据。

但是并不是直接添加好友，而是需要先发一个申请，对方通过后才添加这条好友关系：

![](images/image-5655.jpg)

创建下这个好友申请表：

好友申请表 friend_request：

![](images/image-5656.jpg)
...
![](images/image-5659.jpg)

然后让 guang 向 xiaoqiang 发送好友申请：

![](images/image-5660.jpg)

![](images/image-5661.jpg)

![](images/image-5662.jpg)
...
![](images/image-5664.jpg)

![](images/image-5665.jpg)

再查询下好友请求列表：

![](images/image-5666.jpg)

可以看到，好友状态修改了。

然后查询下好友列表：

![](images/image-5667.jpg)
...
![](images/image-5669.jpg)

测试下：

![](images/image-5670.jpg)
...
![](images/image-5671.jpg)

![](images/image-5672.jpg)
