...
![](images/image-1232.jpg)

我们指定 1k 内存就重启：

    pm2 start xxx --max-memory-restart 1K

![](images/image-1233.jpg)

然后在 nest 代码里用超过 1k 的内存：

![](images/image-1234.jpg)

先把之前的日志清空，使用 pm2 flush 或者 pm2 flush 进程名|id

![](images/image-1235.jpg)

确实清空了：

![](images/image-1236.jpg)

访问下这个 controller：

![](images/image-1237.jpg)

查看 main 进程的前 100 行日志：

    pm2 logs main --lines 100

![](images/image-1238.jpg)
...
![](images/image-1243.jpg)

apps 部分就是配置应用的，scripts 就是应用的启动路径：

![](images/image-1244.jpg)

它可以指定的配置非常多，基本就是命令行有啥选项，这里就有啥属性：

![](images/image-1245.jpg)
...
![](images/image-1246.jpg)

然后在本地执行 pm2 link xxx xxx，把本地的 pm2 和那个网站关联起来：

![](images/image-1247.jpg)

再执行 pm2 plus 就会打开 bucket 对应的网页：

![](images/image-1248.jpg)

可以在线监控你的应用：

![](images/image-1249.jpg)

下面这些 plus 的功能都是收费的：

![](images/image-1250.jpg)
...
![](images/image-1253.jpg)

把它跑起来：

![](images/image-1254.jpg)

![](images/image-1255.jpg)

![](images/image-1256.jpg)

这个就是 pm2 打印的日志。

你可以在 terminal 使用 pm2 的命令：

![](images/image-1257.jpg)
