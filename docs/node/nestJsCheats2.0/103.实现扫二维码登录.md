...
![](images/image-3231.jpg)

如果你 APP 没登录，扫码后会跳到登录页面：

![](images/image-3232.jpg)

登录之后，会进入确认界面，你可以选择授权登录或者取消：

![](images/image-3233.jpg)

这边确认之后，pc 网站就登录了。

知乎，b 站等也是这样的：

![](images/image-3234.jpg)

![](images/image-3235.jpg)
...
![](images/image-3236.jpg)

![](images/image-3237.jpg)

可以看到，二维码的内容是一个 url，如果在手机浏览器打开，是这样的：

![](images/image-3238.jpg)

会让你下载 APP。

而在 APP 里打开，就是登录确认界面了：

![](images/image-3239.jpg)
...
![](images/image-3241.jpg)

扫码后会进入等待用户确认状态：

![](images/image-3242.jpg)

确认后会进入同意授权状态：

![](images/image-3243.jpg)
...
![](images/image-3246.jpg)

扫码后会变成 scanned：

![](images/image-3247.jpg)

知乎也是一样：

![](images/image-3248.jpg)

![](images/image-3249.jpg)

这时候，手机会进入登录确认页面：

bilibili 的登录确认页面：

![](images/image-3250.jpg)

知乎的登录确认页面：

![](images/image-3251.jpg)
...
![](images/image-3260.jpg)

我们用在线解码工具解码下看看：

![](images/image-3261.jpg)
...
![](images/image-3262.jpg)

如果用手机浏览器扫这个码的话，打开的就是下载 APP 的页面：

![](images/image-3263.jpg)

而如果用掘金 APP 扫码，扫出的就是登录确认页面了：

![](images/image-3264.jpg)
...
![](images/image-3266.jpg)

让电脑和手机连接同一个 wifi，然后在手机的 wifi 设置那里设置代理：

代理的 ip 是电脑 ip，端口号就是 charles 代理服务的默认端口 8888

![](images/image-3267.jpg)

这时候电脑上会收到连接提醒，同意下就好了：

![](images/image-3268.jpg)

然后手机就可以访问电脑上的 nest 服务：

![](images/image-3269.jpg)

看到这个 hello world 了没？

这就是电脑上的这个 nest 服务返回的：

![](images/image-3270.jpg)

那个登录确认页面在电脑访问是这样的：

![](images/image-3271.jpg)

然后我把二维码的内容改为这个：

![](images/image-3272.jpg)
...
![](images/image-3273.jpg)

用手机扫码下：

![](images/image-3274.jpg)
...
![](images/image-3275.jpg)

好看多了。

二维码的内容解码后是这样的：

![](images/image-3276.jpg)

然后我们来实现剩下的接口：

![](images/image-3277.jpg)

生成二维码之后，要在 redis 里保存一份，这里我们简化一下，直接用个 map 保存吧。

![](images/image-3278.jpg)
...
![](images/image-3279.jpg)

然后访问 /qrcode/check 拿到这个 id 的状态：

![](images/image-3280.jpg)
...
![](images/image-3281.jpg)

然后调用 qrcode/scan 修改状态，之后调用 qrcode/check 查询下状态：

![](images/image-3282.jpg)

![](images/image-3283.jpg)

同样的方式测试 qrcode/cancel 和 qrcode/confirm 接口：

![](images/image-3284.jpg)

![](images/image-3285.jpg)

![](images/image-3286.jpg)

![](images/image-3287.jpg)

如果 id 不存在，会返回 400 的状态码：

![](images/image-3288.jpg)

![](images/image-3289.jpg)
...
![](images/image-3291.jpg)

打开页面后，生成二维码，这时候就开始轮询二维码状态。

![](images/image-3292.jpg)

手机扫码，进入登录确认页面。

这时候二维码页面的状态变为了等待确认：

![](images/image-3293.jpg)

然后确认登录，这时候 pc 页面变为了已确认状态：

![](images/image-3294.jpg)

![](images/image-3295.jpg)

如果点击取消，那就会变为已取消状态：

![](images/image-3296.jpg)
...
![](images/image-3297.jpg)

然后实现登录接口：

![](images/image-3298.jpg)
...
![](images/image-3299.jpg)

![](images/image-3300.jpg)

![](images/image-3301.jpg)
...
![](images/image-3303.jpg)

这俩按钮分别是登录不同的账号，拿到 token：

![](images/image-3304.jpg)

访问 confirm 接口时带上这个 token：

![](images/image-3305.jpg)
...
![](images/image-3307.jpg)

加上登录之后，我们再测试下：

![](images/image-3308.jpg)

手机扫码，点击登录光的账号，然后确认登录：

![](images/image-3309.jpg)

![](images/image-3310.jpg)

刷新页面，重新扫码，然后登录东东账号。

这时候 pc 网站就显示了当前登录用户是 dong

![](images/image-3311.jpg)
...
![](images/image-3312.jpg)

对比下掘金的扫码登录流程：

![](images/image-3313.jpg)

![](images/image-3314.jpg)

![](images/image-3315.jpg)
