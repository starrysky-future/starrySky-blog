...
![](images/image-1125.jpg)

构建完之后再 run 一下这个新镜像：

![](images/image-1126.jpg)

这次我把我的桌面目录作为数据卷挂载到 /app 目录了：

![](images/image-1127.jpg)

![](images/image-1128.jpg)

容器跑起来后可以看到确实挂载上去了，也标识为了 mount：

![](images/image-1129.jpg)

浏览器访问下：

![](images/image-1130.jpg)

在 inspect 这里也可以看到挂载的目录：

![](images/image-1131.jpg)
...
![](images/image-1132.jpg)

docker 会随机给他生成一个名字。

还会随机生成一个目录作为数据卷挂载上去：

![](images/image-1133.jpg)

inspect 可以看到这时候的路径是一个临时的目录：

![](images/image-1134.jpg)
